...
| Audited active data-* markers | 984 |
| Existing runtime action IDs | 24 |
...
| Places & Ortsentdeckung | 38 | 4 | 2 | 30 | 2 |
...
- Current evidence states: **7** public E2E proofs, **75** local AI paths,
...
2. Keep all 24 typed runtime actions fail-closed while public AI routes are completed domain by domain.
