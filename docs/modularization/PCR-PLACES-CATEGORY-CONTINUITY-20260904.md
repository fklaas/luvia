...
Accepted bounded .46 evidence: source a6bbb89896882b3c941e5007ed8e2f44023503d1, Worker 06c66b30-b8db-4e45-9567-bc080b453dbc, 213/213 safe regression and 30/30 public file hashes. Visible category repeats, current viewport request bounds, simulated error/retry and shared Stays mount passed. Source recovery age/filter exclusions are behavioral-test evidence, not a physical phone test. User browser network blocking was removed; no itinerary or booking writes. Next planned slice remains P09 remove/restore.
