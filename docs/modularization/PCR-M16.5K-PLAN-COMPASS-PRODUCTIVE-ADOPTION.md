# PCR M16.5K — Plan Compass Productive Adoption
...
M16.5K is the first visible Plan/Places/Booking adoption slice, not the complete
...
Rollback is the parent of the M16.5K Consumer commit. The prior M16.5J immutable
