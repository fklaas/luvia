...
Diese Präzisierung ersetzt die frühere Annahme, dass ein Globus als Auftakt und anschließend bestehende Formularschritte die gewählte Gestaltung erfüllen. Der Nutzer findet diese Fortsetzung weiterhin unzureichend. .120 ist ein technischer Zwischenschritt; .121 korrigiert dessen Gestenfläche. Seit .122 ist die gewählte Chat-Gestaltung mit zweistufiger Kontinent-/Land-/Regionenauswahl und drei Reisewegen ausgeliefert. Die Ortsstufe bleibt die echte Zielsuche. Die folgende weitergehende Ausarbeitung und die vollständige KI-Planung sind weiterhin Zielzustand.

### Gelieferte Auswahl und nächste Gestaltungsoptionen

Erster Klick markiert das geografische Gebiet mit laufendem Compass-Farbspektrum und blendet den Namen weich ein; zweiter Klick öffnet es. Das ist auf Kontinent-, Land- und Regionsebene in .122 öffentlich geprüft. Die vorhandene direkte Ortsuche bestätigt weiterhin das echte Reiseziel.

Noch nicht umgesetzt: mitwachsende Reisespur; saisonale Lichtstimmung; Ankunft auf Stadtebene mit belegten echten Ortsbildern; interaktiver Tag-für-Tag-Reisefilm. Diese Optionen vertiefen denselben gewählten Composer, sie ersetzen ihn nicht durch eine neue Gestaltung.
...
Die früheren technischen Einstiege `guided`, `quick`, `ai` mit 9/5/7 Schritten waren **kein Beleg für diese drei Ergebnisse**. .122 nutzt 7/5/7 Schritte und belegt leere Reise sowie explizite Vorschlagsauswahl getrennt; der vollständige echte KI-Entwurf bleibt offen. Die Zuordnung und Wiederaufnahme werden im kanonischen Trip-Auftrag explizit modelliert. Der Renderer besitzt keine zweite Planungswahrheit. Ein Wechsel des Weges muss zeigen, was erhalten bleibt, was nur Entwurf ist und welche Auswahl verworfen würde; keine stillen Kontoaktionen.
...
**Stand 2026-09-07:** Integration **13.82.168.127**, Core **4.82.246**. P15/P17 aktiv und teilweise: Die aktuelle lokale Composer-Fassung kombiniert die drei Reisewege mit dem identischen kanonischen Globus, originalem Luvia-Compass, frei geführten und pro Öffnung variierten Flugpfaden, genau fünf plausibilitätsgeprüften Zielideen sowie automatischer KI-Tagesplanung. Reise-DNA und Zeitreise sind lokal integriert. Die kontrollierte Browserstrecke ist bis zur bestätigten Trip-/Place-Übernahme grün, aber noch kein öffentlich freigegebener Release. Stable .104; Gateway v235 / Intelligence v37 unverändert.

**Zuletzt geliefert:** Funktional geliefert sind neutrale Geografie ohne Kontinentvorauswahl, drei fachlich getrennte Reiseergebnisse, einzelne kurze Reisefragen, wirksame Reise- plus Profilpräferenzen, bis zu vier Place-Momente pro aktivem Tag von morgens bis abends sowie Owner-Readback und idempotente Wiederaufnahme ohne illegale Ledger-Rücktransition. Die lokale Nachfolgefassung liefert fünf statt drei Zielideen, eine sichtbare Erneuern-Funktion und harte Plausibilitätsfilter für ausdrücklich genanntes Ausland, Wärme und kurze Flugdistanz. Ein verstandener KI-Reiseauftrag läuft ohne zusätzliche Ja-Schaltfläche direkt in den Tagesentwurf; ungültige Daten oder ein fehlendes Ziel öffnen den passenden Reparaturschritt. Profilinteressen und Ernährung bestimmen die angefragten Places-Kategorien. Die Reise-DNA zeigt Herkunft und Wirkung der Merkmale in einer animierten Canvas-Projektion. Die Zeitreise stellt frühere Composer-Stände wieder her, verwirft nur abhängige Entwürfe und führt keine Domain-Aktion aus. Flugpfade starten am Compassrand, variieren pro Öffnung und können eine Schleife fliegen. Kontextwellen, Gruppen-Sternbild, Reise-Schatten, Ziel-Zwillinge und Luvia Pulse bleiben als nächste USP-Pakete offen. Keine öffentliche visuelle Freigabe.
...
- Die räumliche Auswahlfassung als professionelle Motion-Bühne fertig ausarbeiten: drei klar verschiedene Wege, warme moderne Tiefe, präzise mittige Typografie in einer offenen gezeichneten Lichtatmosphäre, originaler Luvia-Compass und exakt derselbe kanonische Globus wie in der Zielwahl. Jeder freie Flugpfad beginnt sichtbar am Compass, trägt ein farbgleiches kleines Flugzeug und führt eindeutig zu genau einer Auswahl. Keine Modusnummern, dekorative Mittellinie, geschlossene Titelbox, generierten Bildassets, Pfeilkästen, Messinstrument-Anmutung oder Kollision auf 390-Pixel- und Desktopbreite. Die geografische Zielwahl startet mit stabilem, eingeklapptem Sheet und animiert nur den Griff. Erst sichtbare lokale Freigabe, dann immutable Kandidat.
...
## Verbindliche Verfeinerung am 07.09.2026

Die neue .123-Bühne füllt den Bildschirm. Eingaben kommen in einem weichen, einklappbaren Bottom Sheet; am Desktop liegt es seitlich über derselben Karte. Freitext-Reisewünsche stehen vor Nur anlegen / Mit Vorschlägen / Luvia plant. Modellvorschläge müssen durch Places als reale Ziele bestätigt werden, bevor die Kamera über Kontinent, Land und Region ankommt. Der aktuelle reale Modelllauf ist durch fehlendes API-Guthaben blockiert, daher ist die neue Pipeline bisher nur mit kontrollierten Modellantworten positiv geprüft.

Die vier bisherigen Dynamik-Ideen sind jetzt ausdrücklich angenommen: mitwachsende Reisespur, saisonale Lichtstimmung, echte Ortsbilder bei der Ankunft und interaktiver Reisefilm. Sie werden in dieser Bühne umgesetzt, bleiben aber bis zu ihrer jeweiligen Abnahme offen. Weitere vorgeschlagene Ausarbeitung: nachvollziehbarer Zielvergleich; sofort sichtbare Folgen von Stationswechseln auf Wege, Freiraum und belegtes Budget; fairer Wunschabgleich der Reisegruppe.

P15/P17 bleiben TEILWEISE. Der echte KI-Gesamtplan bleibt ein offenes Gate; das folgende Erlebnis-Paket wird bereits davor umgesetzt.

## Nächstes gebündeltes Composer-Paket · 07.09.2026

Reisespur, Jahreszeitenstimmung, Ankunft und Tagesfilm als gemeinsames Composer-Paket umsetzen.

Die vier vom Nutzer bestätigten Erlebnisfunktionen bauen auf der ausgelieferten .123-Bühne auf. Ihre Darstellung und Bedienung können unabhängig vom Modellguthaben umgesetzt werden. Der reale KI-Gesamtplan bleibt ein gesondertes offenes Abnahmegate.

1. Mitwachsende Reisespur: Geografische Auswahl zeichnet einen feinen Faden; nach der Ortsauswahl verbindet er die tatsächlich gewählten Stationen und Reisetage. Rückschritte und Alternativen aktualisieren dieselbe Spur. Geografische Verbindungen und providerberechnete Wege sind eindeutig unterscheidbar; Animation erzeugt keine zusätzlichen Routing-Anfragen.

2. Jahreszeitenstimmung: Zielkoordinaten und Reisezeit steuern eine weiche atmosphärische Licht-/Farbstimmung mit passender Hemisphäre. Offene Daten bleiben neutral. Die Gestaltung behauptet weder aktuelles Wetter noch Schneelage; echte Vorhersagen benötigen eigene datierte Quellen.

3. Ankunftsmoment: Die Kamerafahrt endet am kanonisch bestätigten Ziel. Wenige Bilder erscheinen ausschließlich bei belegter Zuordnung zum Ziel oder benannten Place. Erste passende Möglichkeiten kommen aus derselben places.v1-Empfehlung. Fehlende Bilder oder Belege führen zu einer bewusst gestalteten Ankunft ohne erfundene Medien oder Passend-Zusage.

4. Interaktiver Tagesfilm: Der vorhandene Entwurf wird mit Tag vor/zurück, Wiedergabe/Pause, Kartenfokus und verständlichen Stationen präsentiert. Tauschen, Tag/Uhrzeit ändern und Details greifen auf die bestehenden Composer-/Trip-/Places-/Journey-Verträge zu. Interaktion pausiert den Ablauf; leere Tage bleiben erkennbar; nur bestätigte Übernahmen schreiben Domain-Daten.

5. Ein gemeinsamer Zustand für Welt, Sheet, Spur und Entwurf; Eingaben, Wiederaufnahme, Zurücknavigation und Moduswechsel erhalten die Auswahl. Keine zweite Planungslogik neben den kanonischen Domain-Ownern.

6. Mobile Gesten, erreichbare Sheets und Tastatur, Reduced Motion sowie begrenzte Render-/Netzlast prüfen. Bewegung darf eine Entscheidung erklären, aber keine Eingabe verzögern oder erzwingen.

7. Bedienung des Tagesfilms mit bestehenden bzw. kontrollierten Entwürfen prüfen und als solchen Nachweis kennzeichnen. Ein vollständig erfolgreicher realer KI-Entwurf über alle Reisetage, Kontoübernahme und physische Geräteabnahme bleiben ausdrücklich offen; kein P15/P17-Gesamtabschluss durch diese Teilabnahme.

Weitere Ideen bleiben Vorschläge: eine frühere Reiseentscheidung zurückspulen und ändern, ohne gültige spätere Wünsche/Daten zu verlieren; ein zurückhaltendes Reisemotiv, das aus bestätigten Entscheidungen sichtbar entsteht. Zuerst wird das angenommene Viererpaket umgesetzt.
...
## Semantisches Travel OS und Entfernung des verfrühten Place-Blicks · 07.09.2026

Der bisherige Abschnitt „Hier könnte eure Reise beginnen“ mit drei allgemeinen Place-Karten entfällt im vollständigen KI-Weg. Er wiederholte die nachfolgende Tagesplanung, zeigte vor dem eigentlichen Entwurf noch keine belastbare Reiseleistung und verwendete bei unterschiedlichen Zielen zu ähnliche Platzhalter. Nach einer KI-Zielidee zeigt der Composer jetzt nur die bestätigte Destination und die konkrete Begründung, warum sie zum Reiseauftrag passt. Reale Places werden anschließend einmalig für den vollständigen Mehrtagesentwurf recherchiert und zuerst dort in ihrem Tageszusammenhang gezeigt. Der historische Ankunftsmoment aus .125 bleibt als damaliger Teilnachweis dokumentiert, ist aber für „Luvia plant alles“ ausdrücklich überholt.

Der lokale Nachfolgekandidat erweitert die semantische Planung zu einer Entwurfs- und Kontrollschleife. Der Reiseauftrag enthält zusätzlich Ankunft und Abreise, Tagesrhythmus, räumliche Präferenzen, gewünschte Puffer und Freiraum, Budgetart, Buchungsabhängigkeiten, Gruppenerfordernisse, belegpflichtige Fakten und Plan-B-Bedarf. `trip.compose` unterscheidet Ankunftstag, volle Tage, Abreisetag und eintägige Reise, verteilt Kategorien über die gesamte Dauer, nutzt kontextuelle Uhrzeiten, bündelt Stationen anhand der gelieferten Koordinaten und erzeugt explizite Ersatzorte. Ein unabhängiger `trip.audit` prüft Vollständigkeit, Tagesrollen, Zeitlogik, Kategorienmix, räumliche Plausibilität, Wiederholungen, Bedürfnisse, Budgetbelege, Buchungsabhängigkeiten, Alternativen und erfundene Tatsachen. Bei einem belegten harten Fehler erhält der Composer genau einen automatischen Reparaturversuch; ein weiterhin blockierter Plan wird nicht zur Übernahme angeboten. In der Tagesansicht steht ein Plan B direkt am betroffenen Moment und lässt sich als nachvollziehbare Alternative einsetzen.

Die folgenden KI-Funktionen bilden den weiteren Ausbau. Sie verwenden denselben Trip-, Places-, Journey-, Identity- und Context-Zustand; jede Änderung bleibt vor der Übernahme sichtbar und bestätigungspflichtig:

1. **Flexible Zeitfenster und Ferienintelligenz:** Aus Formulierungen wie „zwei Wochen im Sommer mit Kindern“ passende Intervalle ableiten, regionale Schulferien, Feiertage, Klima und Preisniveau als getrennte datierte Belege vergleichen und zwei bis vier begründete Zeitfenster anbieten. Abhängigkeit: verifizierter Ferienkalender sowie aktuelle Wetter-, Preis- und Eventquellen.
2. **Ankunfts- und Abreiselogistik:** Flug-, Bahn-, Fahr- oder Check-in-Zeiten, Transfers, Gepäck, Jetlag, erste Mahlzeit und einen bewusst leichten letzten Tag einplanen. Unbekannte Verbindungen bleiben offen; echte Verkehrsdaten kommen über den Move Owner.
3. **Unterkunft als räumlicher Anker:** Sobald eine Unterkunft feststeht, tägliche Cluster und Wege von dort aus optimieren. Ohne Unterkunft arbeitet Luvia mit klar gekennzeichneten Zielgebieten und kann die günstigste Lage für den entstandenen Plan vorschlagen.
4. **Realer Tagesrouten-Solver:** Öffnungszeiten, Aufenthaltsdauer, reale Wege, Verkehrsmittel, Puffer, Essenszeiten und feste Termine gemeinsam lösen. Ein Entwurf wird nicht wegen rechnerisch naher Luftlinie als praktikabel ausgegeben. Abhängigkeit: aktuelle Places- und Routingbelege.
5. **Kontextwellen und laufende Neuplanung:** Wetter, Hitze, Regen, Streik, Schließung, Veranstaltung oder starke Auslastung nur bei neuem Beleg in den betroffenen Tag einblenden. Luvia erklärt die Auswirkung und bietet eine lokale Reparatur, ohne die restliche Reise zurückzusetzen.
6. **Reise-Schatten und Was-wäre-wenn:** Neben dem aktiven Entwurf eine Alternative für „ruhiger“, „günstiger“, „weniger laufen“, „mehr Strand“ oder „einen Tag länger“ berechnen. Vor der Übernahme werden geänderte Orte, Wege, Freiraum, Preisbelege und offene Fakten gegenübergestellt.
7. **Reservierungsfahrplan:** Reservierungspflichtige Orte und knappe Fristen erkennen, eine Reihenfolge für Entscheidungen vorschlagen und Alternativen bereithalten. Das System behauptet weder Verfügbarkeit noch Buchung, bevor der zuständige Provider dies bestätigt.
8. **Budgetverlauf:** Belegte Fixkosten, Tagesrahmen und unbekannte Kosten getrennt führen. Luvia erkennt früh, an welchem Tag der Rahmen wahrscheinlich kippt, und kann gezielt eine Station austauschen. Unbelegte Preise bleiben sichtbar unbekannt.
9. **Gruppen-Sternbild und faire Planung:** Bestätigte Interessen, Belastungsgrenzen und Muss-Ziele der Mitreisenden ausgleichen; zeigen, wer an welchem Tag berücksichtigt wird, und Konflikte mit mehreren fairen Varianten lösen. Abhängigkeit: Mitreisendenidentitäten, Rollen und Einwilligungen.
10. **Belastungs- und Zugänglichkeitsmodell:** Gehstrecke, Höhenprofil, Hitze, Ruhepausen, Kinder-Schlaf- und Essensrhythmus, Rollstuhlzugang und sensorische Belastung in den Tagesaufbau einrechnen. Eigenschaften dürfen nur bei belastbarer Quelle als erfüllt gelten.
11. **Ziel-Zwillinge:** Zwei bestätigte Destinationen mit demselben Reiseauftrag komplett probeplanen und anhand Tagesqualität, Anreise, Budgetbelegen, Interessenabdeckung und Unsicherheit vergleichen, statt nur allgemeine Pros und Contras zu nennen.
12. **Faktenfrische und Eigenkritik:** Vor der finalen Übernahme zeitkritische Öffnungen, Preise, Events, Routen und Reservierungsbedingungen erneut prüfen. Der Qualitätsprüfer nennt Widersprüche, Datenalter und verbleibende Risiken; die eigentliche Planungsinstanz bewertet sich nicht allein.
13. **Vorbereitungsassistent:** Aus bestätigtem Ziel und Zeitraum eine belegte Vorbereitungsliste für Reservierungen, Tickets, Einreiseunterlagen, Mobilität und Gepäck ableiten. Medizinische, rechtliche und Einreiseangaben benötigen aktuelle offizielle Quellen.
14. **Bewusstes Lernen nach der Reise:** Erst nach einer ausdrücklichen Rückmeldung lernen, welcher Rhythmus, welche Kategorien und welche Wege tatsächlich passten. Die Person sieht Geltungsbereich und Ursache, kann korrigieren oder vergessen; stilles Profilieren zählt nicht als Lernerfolg.

Bereits lokal umgesetzt sind Reise-DNA, Zeitreise, semantischer Reiseauftrag, Zielbegründungen, Tagesrollen, Kategorienmix, räumliche Koordinatenvorgabe, Plan-B-Zuordnung sowie die unabhängige Entwurfsprüfung mit einem Reparaturdurchlauf. Kontextwellen, Gruppen-Sternbild, Reise-Schatten, Ziel-Zwillinge und Luvia Pulse bleiben die nächsten sichtbaren Produktpakete. Die übrigen Punkte benötigen teilweise neue, verifizierte Providerdaten und werden bis dahin weder als vollständige Live-Funktion noch als belegte Tatsache dargestellt.

Nächster Schritt: die verifizierte Ferien- und Zeitfensterquelle anbinden; danach Ankunfts-/Abreisefakten und reale Wege als erste externe Belege in dieselbe Audit-Schleife aufnehmen.
