...
**Stand 2026-09-07:** Integration **13.82.168.127**, Core **4.82.246**. P15/P17 aktiv und teilweise: .128 trägt die funktionalen Korrekturen für drei Composer-Wege, stabile Geografie, präferenzgesteuerte Places, vollständigere Tage und sichere Ledger-Wiederaufnahme. Seine Eröffnungsoptik ist verworfen. Die lokale Nachfolgestudie nutzt den identischen kanonischen Natural-Earth-/D3-Globus in Einstieg und Zielwahl, den originalen Luvia-Compass und eine mittige Überschrift in einer offenen gezeichneten Lichtatmosphäre. Drei freie Spektrum-Flugpfade beginnen am Compassrand, tragen kleine farbgleiche Flugzeuge und führen zu einer engeren, kollisionsfreien Auswahlkomposition. Nach der Wegwahl übernimmt derselbe Globus die Bühne; der Zielwahl-Sheet startet eingeklappt und animiert nur den Griff. Die Fassung ist lokal browsergeprüft, aber noch kein freigegebener Release. Stable .104; Gateway v235 / Intelligence v37 unverändert.

**Zuletzt geliefert:** Funktional geliefert sind neutrale Geografie ohne Kontinentvorauswahl, drei fachlich getrennte Reiseergebnisse, einzelne kurze Reisefragen, wirksame Reise- plus Profilpräferenzen, bis zu vier Place-Momente pro aktivem Tag von morgens bis abends sowie Owner-Readback und idempotente Wiederaufnahme ohne illegale Ledger-Rücktransition. Die aktuelle lokale Fassung verbreitert die belegte Kandidatenmenge je gewählter Kategorie, verwebt Kategorien entsprechend der gewählten Mischung und entfernt die alte unerreichbare Mehrfach-Aktionsleiste aus dem Vorschlagspfad. Lokal belegt sind derselbe Globe-Renderer vor und nach der Moduswahl, die drei funktionierenden Einstiege, der weiche Globe-Übergang und der geschlossen/öffnend bedienbare Zielwahl-Sheet. Auswahlhalos sind feiner; Modusnummern, künstlicher Ersatzkompass, geschlossene Titelbox und dekorative Mittellinie sind entfernt. Die sieben Ideen Zeitreise, Kontextwellen, Gruppen-Sternbild, Reise-Schatten, Ziel-Zwillinge, Luvia Pulse und Reise-DNA sind verbindlich aufgenommen, aber nicht als umgesetzt behauptet. Die .128-Illustration ist Gegenbeleg, kein visueller Abschluss.
