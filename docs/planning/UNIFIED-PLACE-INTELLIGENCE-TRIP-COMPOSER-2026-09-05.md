...
**Stand 2026-09-07:** Integration **13.82.168.133**, Core **4.82.252**. P17/P19 aktiv und teilweise: App .133 / Core .252 korrigieren im Integration-Kandidaten die echte Semantik von groben Monatsfenstern plus ausdrücklich genannter Reisedauer. Der zuvor veröffentlichte Vertrag aus .132 verbindet den Reiseauftrag bereits mit Reiseversprechen, bewusstem Freiraum, Tagesbalance, belegpflichtiger Unsicherheitskarte, Buchungsreihenfolge und modelliertem Unterkunftsradius. 239/239 Safe Regression, 108 Composer-Prüfungen, Health, Workerstatus und 8/8 öffentliche Byteidentität sind für .132 belegt; .133 durchläuft jetzt denselben Gate und den erneuten authentifizierten Lauf. Gateway v235, Main und Production bleiben unverändert.
