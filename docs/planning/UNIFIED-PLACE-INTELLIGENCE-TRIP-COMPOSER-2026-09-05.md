...
**Stand 2026-09-08:** Integration **13.82.168.164**, Core **4.82.283**. P17/P19 aktiv und teilweise: App .163 / Core .282 und Intelligence v50 / 4.40.1 sind öffentlich auf Integration. Der echte Familien-/Ferienlauf liefert fünf passende Zielrichtungen und ein autoritatives Ferienfenster, blieb danach aber zu lange in seriellen Places-Nachsuchen hängen. App .164 / Core .283 ist der Frontend-Kandidat für parallele Wunschsuche, priorisierte Pflichtkategorien und ehrliche Kategorieherkunft. Gateway v235, Intelligence v50, Main und Production bleiben funktional unverändert.

**Zuletzt geliefert:** Der semantische Reiseauftrag trennt jetzt drei Ebenen. Vor dem Plan müssen echte Zielkonflikte, Bewegungsradius, feste Termine sowie harte Gesundheits- und Budgetgrenzen entschieden sein. Luvia darf einen ausgewogenen Tagesrhythmus, 20 bis 25 Prozent sichtbaren Freiraum, eine Unterkunftsbasis und höchstens zwei intensive Tage in Folge vorbelegen; diese Annahmen sind sichtbar und mit einem Klick änderbar. Erst nach dem Entwurf folgen aktuelle Prüfungen für Öffnungen, Wetter, Preise, Buchbarkeit, Veranstaltungen, Einreise und Verkehr in Unsicherheitskarte und Buchungsreihenfolge. .164 startet alle expliziten Place-Kategorien parallel, wiederholt nur fehlende Nutzerwünsche und lässt reine Profilergänzungen den ersten Gesamtplan nicht blockieren. Der Reiseauftrag trennt harte Anforderungen von gewünschten Schwerpunkten; ein reichhaltiger Reisewunsch wird nicht mehr durch ungefragte Wellness- oder andere Profilkategorien überlagert. Konfliktmoderator, Bewegungsradius, räumliche Vielfalt, harte Interessenabdeckung, kompakter Planungscheck, seitliches Desktoplayout und drei klickbare Tageskartenrichtungen bleiben enthalten.
