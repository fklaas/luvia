...
## Integration .199: gemessenen Wunschverlust beheben
...
## Integration .200: gemessene Webkosten und offener Ortsabgleich

Quelle `bf81e063eebeeb4f144f35c7054611efa76cd011`, App 13.82.168.200 / Core 4.82.319, Worker `79214166-2224-49b0-8795-9788d64a6272`. Stable und Immutable stimmen in 28/28 Dateien mit dem sauberen Archiv überein: 92.732.738 Bytes, SHA-256 `03ca4fcbfd707c7a7d2b95ebc6835f57afe90c78c77c82bc93e8df2d8d5c34a4`. Integration-Intelligence bleibt v12 / 4.43.8 aus fa5a4cfd; Integration-Gateway bleibt v1 / 4.64.39 aus a70ad775. Produktion unverändert.

Der echte .199-Interpreter behielt 11/11 Ziele, gab jedoch „mittleres Budget“ sowohl als qualitative Preisvorliebe als auch als harte Reisesumme zurück. .200 löst diesen widersprüchlichen Betragsschlüssel ohne erfundene Geldsumme auf; echte finanzielle Obergrenzen bleiben unberührt. Der unveränderte Modelloutput ist lokal vollständig weiterverwendbar. 54 Web-/Budget-/Wunscherhalt-, 133 Composer- und 27 Intentprüfungen sowie Build, Status und Inventar bestehen. Die 245er-Regression wurde für .199 ausgeführt; nach den kleinen .200-Korrekturen wurden gezielt die betroffenen Gates wiederholt.

Der authentifizierte .200-Workflow `30d9c722-6525-4385-a467-747a83d9b91f` verwendete den bestehenden Wunschdeutungsjob ohne erneute Modellkosten. Nach etwa 22 Sekunden zeigte die UI 56 Orte und die ergänzende Webrecherche. Der Webjob `df9bd8a3-c628-4aec-95f7-f401df6040e8` lieferte in 9.229 ms sechs Nachtleben-Hinweise mit tatsächlich recherchierten Quellen. Zwei Toolsuchen, 21.117 Eingabe- und 507 Ausgabetokens ergeben nach aktuellen Luna-Standardpreisen 0,0248318 USD. Dies ist der erfolgreiche **Webprovider-Nachweis**, kein erfolgreicher Gesamtplan.

Der anschließende Places-Abgleich übernahm 0/6 Ortsidentitäten. Der Audit wies unspezifisches „Km 0“ und Sportstätten ohne Escape-Room-/Bowling-Beleg korrekt zurück. Der gesamte Lauf endete nach rund 89 Sekunden mit drei Modellaufrufen und 48.204 Tokens. Die öffentliche Suche ohne Anmeldung wurde mit AUTH_REQUIRED abgewehrt; kein Schutz wurde umgangen. Providerzustände zeigen Geoapify zuletzt ohne HTTP-Antwort und HERE zuletzt 400, belegen aber noch nicht die Ursache jedes einzelnen Namensabgleichs. Die HERE-Referenz erlaubt bei Discover nur eines von at/circle/bbox; Browse benötigt hingegen at und darf es mit in kombinieren. Ein pauschales Entfernen von at wäre daher falsch. Als nächstes sind die konkrete Ortszuordnung aus gespeicherten Quellen und der spezifische Aktivitätsbedarf zu schließen; weder ein weiterer unkontrollierter Weblauf noch ein aufgelockerter Audit ersetzt diesen Beleg.
...
Kontrollierte Prüfung: **244/244** Safe Regression einschließlich **27/27** neuer Intent-/Shopping-/Auditprüfungen, **133** Composer, **145/145** Transport, **32/32** Erlebnis-/A2-Prüfungen und **24/24** Recherchebelege. Die lokale Browserfixture hatte einen Strand als tourist_attraction deklariert; die neue Prüfung wies ihn korrekt zurück. Die isolierte Fixture wurde auf beach beziehungsweise shopping_mall berichtigt und die betroffenen Verhaltenstests erneut geprüft. Diese Testdaten sind ausdrücklich kein echter Valencia-Qualitätsnachweis. Veröffentlicht aus Commit 2d4796cef99e1ffe83c1c5d484d571d4e11823f2 als App 13.82.168.197 / Core 4.82.316. Worker 4c4a8ce7-4d26-4c01-acf9-9e361e24970e; stabile und unveränderliche URL bedienen 27/27 geprüfte Dateien exakt aus dem sauberen Archiv. Archiv: 225587582 Bytes, SHA-256 6c424d4626db30c912e96d643a620d9bf837bc308f56d66b63e01534d6d9805d. Nach der vollständigen Regression wurden die kleinen Fixture- und Annahmeneditor-Korrekturen gezielt mit Composer 133, Transport 145, Intent 27 und Erlebnis/A2 32 erneut geprüft. Integration-Gateway und -Intelligence bleiben beim veröffentlichten .196-Stand. Der bestehende öffentliche Sieben-Tage-Entwurf blieb nach Reload erhalten; kein neuer kostenpflichtiger Gesamtplan wurde als Qualitätsbeleg ausgegeben.
