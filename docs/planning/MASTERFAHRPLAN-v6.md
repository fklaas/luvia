...
Aktuell öffentlich belegt sind App 13.82.168.102 / Core 4.82.221 auf Integration-Worker b73732a6-26f4-4280-9d0d-88eb0429094a aus Runtime-Commit 71a697adcbf1549c6ee78f379743983689a95276. Gateway v231 meldet 4.64.35 und Places 4.38.14-cold-hedge-commons-category. 30/30 releasekritische Dateien stimmen im sauberen Deployment-Byte-Archiv, auf Stable und auf dem immutable Worker überein. Das byteidentische Archiv luvia-integration-13.82.168.102-71a697ad-public-bytes.zip hat 89.020.093 Bytes und SHA-256 54148CE5ECB50751B055B8B5D270918BA6C34EF864A467FBA8A9F34FD59D71C3. Safe Regression 232/232 und NFR-0 3/3 sind grün. Main und Production bleiben unverändert.
...
Der öffentliche Stand .102 begrenzt kalte Spezialanfragen und lässt die kostenlose, cachegestützte OSM-Kategoriesuche bei strikten Spezialtypen parallel zu Geoapify anlaufen. Die kalte Minigolfprobe sank im Gateway von 5,58 auf 2,44 Sekunden; ihre gesamte öffentliche Antwort benötigte 3,29 Sekunden. Warme und weitere Gatewayproben lagen bei 0,15 bis 0,24 Sekunden. Minigolf liefert Strandgolfer und Schwarzlicht Minigolf, chinesische Küche Hay-Cheng und strikter Strandbedarf drei passende Bedarfsorte. Verknüpfte Wikimedia-Commons-Kategorien werden jetzt als exakte Medienquelle aufgelöst; Logos, Karten, Pläne, Diagramme und nicht bildartige Dateien bleiben ausgeschlossen, Autor und Lizenz sind Pflicht. Sichtbar zeigt Places Food 48 Alle und 9 Passend ohne Kleines Steakhouse; Stays schaltet im gleichen Kartenaufbau von 47 Alle auf 25 Passend. P02 bleibt teilweise: Die Kandidaten waren beim ersten sichtbaren Kartenaufruf nach 3,6 Sekunden vorhanden, alle Pins aber erst nach rund 5,8 Sekunden sichtbar. Die breite reale Ortsbildquote, die vollständige Touch-/Sachfiltermatrix sowie positive Google-/Foursquare-Livepfade sind noch offen; Google lieferte zuletzt 403 und Foursquare 429 mit Cooldown.

**Nächster Abschlussnachweis:** Den ersten sichtbaren Kartenaufbau auf höchstens drei Sekunden bringen, die exakte reale Bildquote für alle 14 Kategorien und Stays messen und erweitern und danach alle 82 Zuordnungen, 19 Landesküchen sowie Sachfilter auf Desktop und Touch positiv, negativ, leer und bei Providerteilausfall abnehmen.
...
App .102 verwendet weiterhin denselben places.v1-Kandidaten-, Filter-, Passend- und Medienweg für Places, Stays, Timeline-Vorschläge und AI Chat. Diagnose und Chat teilen die beschleunigte Spezialtypenkaskade; die öffentliche Chat-Minigolfprobe liefert dieselben zwei OSM-Orte wie die Kartendiagnose. Sichtbar sind Places Food 48/9 mit strengem vegetarischem Ausschluss und Stays 47/25. Exakte Commons-Kategorien ergänzen ausschließlich verknüpfte, lizenzierte Ortsbilder. Die vollständige sichtbare Foto-, Filter- und Erstaufbauparität in Timeline-Vorschlägen und AI Chat bleibt Teil des aktiven P02/P03-Abschlusses.

**Nächster Abschlussnachweis:** Ersten sichtbaren Kartenaufbau und reale Ortsbildquote im gemeinsamen Places Owner schließen und anschließend dieselben Kandidaten, Sachfilter, Passungsgründe, Medien, Frische- und Fehlerbelege in Stays, Timeline-Vorschlägen und AI Chat sichtbar abnehmen.
...
App 13.82.168.102 / Core 4.82.221: Runtime-Commit 71a697adcbf1549c6ee78f379743983689a95276, byteidentisches Deployment-Byte-Archiv luvia-integration-13.82.168.102-71a697ad-public-bytes.zip mit 89.020.093 Bytes und SHA-256 54148CE5ECB50751B055B8B5D270918BA6C34EF864A467FBA8A9F34FD59D71C3, Gateway v231 / 4.64.35 / Places 4.38.14-cold-hedge-commons-category, Worker b73732a6-26f4-4280-9d0d-88eb0429094a, 232/232 Safe Regression, NFR-0 3/3 und 30/30 öffentliche Byteidentität. Sichtbar: Places Food 48 Alle und 9 Passend ohne Steakhouse sowie Stays 47/25. Die kalte Minigolfprobe sank im Gateway auf 2,44 Sekunden. Main und Production unverändert.
