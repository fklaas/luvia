...
Integration läuft auf App 13.82.168.58 und Core 4.82.180 mit Gateway v170. Die Kartenreparaturen sind ein Teil der aktiven B1-Arbeit. Sie ersetzen weder den vollständigen B1-Nachweis noch den gemeinsamen Design Freeze. Geoapify, TomTom und HERE bilden die aktive budgetbewusste Kaskade; die aktuelle Provider-Kontinuität ist im P02/P03-Bericht belegt.
