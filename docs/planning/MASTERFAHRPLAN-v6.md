...
App .86 verwendet für den positiven Profil-Ernährungsnachweis dieselbe streng belegte Kaskade aus HERE, begrenztem Google und Foursquare. HERE liefert in 8/15 km um Scharbeutz weiterhin 0 explizite vegetarische Orte; Google endet mit 403 Permission; Foursquare mit 429 ohne Credits. Deshalb bleibt ein Steakhaus ohne dedizierte vegetarische Klassifikation ausgeschlossen und Passend sichtbar bei 0/0, während Alle 50 reale Essen-&-Trinken-Pins zeigt. Der gemeinsame Filtervertrag für 14 Kategorien, 82 Typ-/Untertypen, 19 Landesküchen und alle Faktenfilter bleibt grün. Das Google-Cloud-Projekt besitzt laut Nutzerangabe 1.000 Aufrufe pro Tag; Luvia hält vorerst das engere Search-Budget von 4/min, 25/Tag und 800/Monat ein und verwendet zuerst Cache, zusammengeführte Anfragen und freie Provider. 227/227 Safe Regression PASS. Positive Google-Breite, vollständige UI-/AI-Matrix, breite exakte Fotos und physische Mobilzeiten bleiben offen.

**Nächster Abschlussnachweis:** Im bereits geöffneten Google-Cloud-Projekt anmelden, Places API (New), Billing und die API-Key-Beschränkung prüfen; danach den öffentlichen Health-Probe ohne 403 sowie mindestens einen realen vegetarischen Scharbeutz-Treffer mit identischer Provider-ID und verständlichem Grund in Places, Timeline und AI Chat sichtbar abnehmen. Das interne 25/Tag-Budget bleibt bis zur Nutzungs- und Kostenmessung bestehen.
...
Karte, Timeline-Vorschläge und AI Chat konsumieren denselben places.v1-Filtervertrag und denselben providerbelegten Alle-/Passend-Bestand. Separat gefundene Ernährungsbelege werden nur über identische Providerreferenz oder exakt gleichen normalisierten Namen innerhalb 25 Metern verbunden. Der negative Steakhouse-Fall und positive Google-, HERE- und Foursquare-Fixtures sind automatisiert grün. Auf öffentlicher Integration liefert Alle 50 Essen-&-Trinken-Pins und Passend für das vegetarische Profil ehrlich 0/0. Der positive Realbeleg fehlt weiterhin, weil HERE 0 explizite Treffer liefert, Google 403 und Foursquare 429 zurückgeben.

**Nächster Abschlussnachweis:** Nach Anmeldung und Freigabe der Google Places API (New) denselben realen positiven Ernährungsort in Places, Timeline-Vorschlag und AI Chat mit gleicher Provider-ID, gleichem Reisezielradius und verständlichem Passend-Grund sichtbar belegen.
