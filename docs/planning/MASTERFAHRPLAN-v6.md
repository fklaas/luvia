...
Integrationskandidat App 13.82.168.85 / Core 4.82.207 ist gebaut und mit 226/226 Safe Regression belegt; Veröffentlichung, Archiv und öffentliche Bytegleichheit folgen nach dem sauberen Runtime-Commit. Bis dahin bleibt App .84 auf Worker 89e712c7-c8ce-43fb-856f-229fc5055ee3 der aktive Frontendstand. Gateway v202 / 4.64.20 ist aktiv und meldet Places-Health 4.38.1-here-dietary-evidence. Additive Google-/Foursquare-Budgetregeln und Diagnose-Cooldown-Resets sind angewendet. Main bleibt c4b6d174 unverändert. PCR: docs/modularization/PCR-P02-P03-POSITIVE-FOOD-FIT-20260905.md.

**Nächster Abschlussnachweis:** App .85 aus dem sauberen Commit ausschließlich auf integration-luvia veröffentlichen, Archiv, Stable/Immutable-Bytes, sichtbare Oberfläche und exakten Rückfall belegen.
...
App .85 führt den positiven Profil-Ernährungsnachweis über HERE, danach begrenzt Google und Foursquare. HERE sekundäre Vegetarian/Vegan Food-Types gelten als positiver Verfügbarkeitsfakt; nationale Landesküchen erfordern weiter den primären HERE-Food-Type. Foursquare bildet die offizielle Kategorie Vegan and Vegetarian Restaurant ab. Google-search ist auf 4/min, 25/Tag und 800/Monat begrenzt; Foursquare-search auf 2/min, 12/Tag und 300/Monat, Details/Fotos bleiben deaktiviert. Der öffentliche Befund ist eindeutig: HERE antwortet, liefert in 8 km und 15 km um Scharbeutz aber 0 explizite vegetarische Orte; Google endet mit 403 Permission; Foursquare mit 429 ohne API-Credits. Der gemeinsame Filtervertrag für 14 Kategorien, 82 Typ-/Untertypen, 19 Landesküchen und alle Faktenfilter bleibt grün. Ein Steakhaus ohne dedizierte vegetarische Klassifikation bleibt ausgeschlossen. 226/226 Safe Regression PASS. Positive sichtbare Providerbreite, vollständige UI-/AI-Matrix, breite exakte Fotos und physische Mobilzeiten bleiben offen.

**Nächster Abschlussnachweis:** Im Google-Cloud-Projekt Places API (New), Billing und API-Key-Beschränkung so prüfen, dass der vorhandene Key eine Place-Suche ausführen darf; danach mindestens einen realen vegetarischen Scharbeutz-Treffer mit identischer Provider-ID und Begründung in Karte, Timeline und AI Chat sichtbar abnehmen.
...
Karte, Timeline-Vorschläge und AI Chat konsumieren denselben places.v1-Filtervertrag und denselben providerbelegten Alle-/Passend-Bestand. Separat gefundene Ernährungsbelege werden nur über identische Providerreferenz oder exakt gleichen normalisierten Namen innerhalb 25 Metern verbunden. Der negative Steakhouse-Fall und positive Google-, HERE- und Foursquare-Fixtures sind automatisiert grün. Der öffentliche positive Realbeleg fehlt, weil HERE 0 explizite Treffer liefert, Google 403 und Foursquare 429 zurückgeben.

**Nächster Abschlussnachweis:** Nach der Google-Freigabe denselben realen positiven Ernährungsort in Places, Timeline-Vorschlag und AI Chat mit gleicher Provider-ID, gleichem Reisezielradius und verständlichem Passend-Grund belegen.
