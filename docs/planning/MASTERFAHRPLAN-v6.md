...
App .132 / Core .251 und Intelligence 4.38.0 bilden einen erweiterten P17-Vertrag: Der vollständige KI-Entwurf muss ein prüfbares Reiseversprechen, expliziten Freiraum, geplante und freie Minuten sowie eine reiseweite Belastungsbalance liefern. Jede Place-Entscheidung trägt einen Belegzustand; eine Unsicherheitskarte hält Wetter, Preis, Öffnung, Route, Verfügbarkeit und Buchung sichtbar offen, solange kein datierter Providerbeleg vorliegt. Eine Buchungsreihenfolge beschreibt blockierende Entscheidungen und der Unterkunftsradius wird nur als modellierte Ableitung aus den tatsächlich verwendeten Places ausgewiesen. Der unabhängige Audit darf den Entwurf nur freigeben, wenn das Reiseversprechen gehalten wurde. 108 kontrollierte Composer-Verhaltensprüfungen, Structured-Output-Schema, Core- und Owner-Gates sind grün. Live-Modell, produktive Ferien-/Unterkunfts-/Transportanbieter, Konto-Reload und physische Geräte bleiben offen. App .146 / Core .265 ergänzt einen 24 Stunden gültigen, nutzergebundenen Reiseauftrag: Wunschdeutung, kanonische Places-Kandidaten, Erstentwurf, datierte Tagesreparatur und globaler Audit werden als Phasen gespeichert; jede Modellstufe besitzt eine stabile Idempotenz-ID. Reload oder App-Wechsel liest denselben Auftrag, eine erfolgreiche Modellstufe wird nicht erneut berechnet, und ein verwaister Lauf darf nach vier Minuten kontrolliert wieder aufgenommen werden. Direkter Tabellenzugriff für anon/authenticated ist gesperrt; erfolgreiche Eingaben werden nach dem Ergebnis verworfen. App .156 / Core .275 behebt die im echten Lauf gefundenen Checkpoint-, Kategorie- und Reparaturverluste: Checkpoints sind inkrementell, der serverseitige semantische Auftrag steuert die Places-Kategorien, strukturell ungültige Einzelteile werden tageweise repariert, Teilreparaturen bleiben erhalten und eine Kategorienachversorgung wird einmalig checkpointed und nach 50 Sekunden beendet. Der frische Valencia-Auftrag lieferte fünf passende Richtungen, drei Juni-Fenster und den direkten Gesamtplanstart. Der positive Gesamtabschluss fehlt: Tag 4 blieb offen; danach zeigte die Wiederaufnahme einen AI_JOB_IDEMPOTENCY_CONFLICT zwischen clientseitiger Job-ID und serverseitigem Payload-Fingerabdruck.

**Nächster Abschlussnachweis:** Zuerst den realen Job-Fingerabdruckkonflikt beheben und den Valencia-Auftrag ohne Wiederholung erfolgreicher Phasen bis Reiseversprechen, sieben vollständigen Tagen, Audit und Review-Freigabe abschließen. Danach einen Familien-/Ferienfall positiv prüfen und erst anschließend Kontoübernahme, Timeline-/Owner-Receipts und physische Geräte schließen.
...
Die Twin-Projektion ist im Composer-Vertrag teilweise umgesetzt. Verifizierte Ferienintervalle müssen Quellen-ID, Region, Anfang und Ende tragen; unpassende feste Zeiträume werden blockiert. Der vollständige KI-Entwurf normalisiert nun eine Unsicherheitskarte mit belegten, modellierten und offenen Zuständen. Ein angeblich verifizierter Zustand wird ohne bekannte Evidence-ID, Quelle und gültigen Abrufzeitpunkt automatisch auf offen zurückgestuft. Fehlende Wetter-, Preis-, Öffnungs-, Routen-, Verfügbarkeits- und Buchungszustände werden ausdrücklich ergänzt statt verschwiegen. Ein Unterkunftsradius gilt nur als modelliert, wenn er auf tatsächlich verwendete kanonische Places verweist. Produktive Live-Belege für Wetter, Feiertage, Events, Öffnung, Wege, Preise, Unterkünfte und Buchbarkeit bleiben offen. App .146 / Core .265 ergänzt einen 24 Stunden gültigen, nutzergebundenen Reiseauftrag: Wunschdeutung, kanonische Places-Kandidaten, Erstentwurf, datierte Tagesreparatur und globaler Audit werden als Phasen gespeichert; jede Modellstufe besitzt eine stabile Idempotenz-ID. Reload oder App-Wechsel liest denselben Auftrag, eine erfolgreiche Modellstufe wird nicht erneut berechnet, und ein verwaister Lauf darf nach vier Minuten kontrolliert wieder aufgenommen werden. Direkter Tabellenzugriff für anon/authenticated ist gesperrt; erfolgreiche Eingaben werden nach dem Ergebnis verworfen. App .156 / Core .275 behebt die im echten Lauf gefundenen Checkpoint-, Kategorie- und Reparaturverluste: Checkpoints sind inkrementell, der serverseitige semantische Auftrag steuert die Places-Kategorien, strukturell ungültige Einzelteile werden tageweise repariert, Teilreparaturen bleiben erhalten und eine Kategorienachversorgung wird einmalig checkpointed und nach 50 Sekunden beendet. Der frische Valencia-Auftrag lieferte fünf passende Richtungen, drei Juni-Fenster und den direkten Gesamtplanstart. Der positive Gesamtabschluss fehlt: Tag 4 blieb offen; danach zeigte die Wiederaufnahme einen AI_JOB_IDEMPOTENCY_CONFLICT zwischen clientseitiger Job-ID und serverseitigem Payload-Fingerabdruck.

**Nächster Abschlussnachweis:** Zuerst AI_JOB_IDEMPOTENCY_CONFLICT mit einer gemeinsamen kanonischen Client-/Server-Identität schließen und den Valencia-Workflow positiv belegen. Danach Familien-/Ferienfall und je einen echten datierten Wetter-, Öffnungs-, Routen-, Event- und Preisbeleg samt Ablauf, Provenienz und Invalidierung verfolgen.
