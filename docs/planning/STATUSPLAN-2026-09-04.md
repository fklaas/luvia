...
Aktuell öffentlich belegt sind App 13.82.168.103 / Core 4.82.222 auf Integration-Worker 075622ac-defa-4cef-8e20-43684302b7e8 aus Runtime-Commit 3d6442c749557711db6d63e2c1fb24e04b84081a. Gateway v232 meldet 4.64.35 und Places 4.38.14-cold-hedge-commons-category. 30/30 releasekritische Dateien stimmen im sauberen Deployment-Byte-Archiv, auf Stable und auf dem immutable Worker überein. Das byteidentische Archiv luvia-integration-13.82.168.103-3d6442c7-public-bytes.zip hat 89.022.652 Bytes und SHA-256 A8784AF164D66E9187FB7A588BB363167E54B8B99D797D92785989F578E41D5F. Safe Regression 232/232 und NFR-0 3/3 sind grün. Main und Production bleiben unverändert.
...
Der öffentliche Stand .103 beginnt MapLibre, die OpenFreeMap-Verbindung und den Kartenstil bereits im Dokumentkopf. Vorhandene exakte Pins werden freigegeben, während externe Kartendaten im Hintergrund laden. Im sichtbaren Stable-Browser waren 48 Places-Pins nach 1,731 Sekunden und 47 Stays-Pins nach 1,615 Sekunden nutzbar. Places Food schaltet reproduzierbar zwischen 48 Alle und 9 Passend; Kleines Steakhouse bleibt ohne Passend-Beleg. Stays schaltet zwischen 47 Alle und 25 Passend. Zoom behält eine bedienbare Karte und lädt den sichtbaren Ausschnitt nach. Die gemeinsame Projektion trägt Provider, Lizenz, exakte Entitätsreferenz, verknüpfte Ortsquelle und Verifikationsstatus bis zum Consumer und meldet die Bildabdeckung ohne zusätzliche Providerreads. Die kalte Minigolfprobe blieb bei 2,447 Sekunden Gatewayzeit; warme und weitere Proben lagen bei 0,150 bis 1,101 Sekunden. P02 bleibt teilweise: breite reale Ortsbildquote, physischer Mobil-Kaltstart, vollständige Touch-/Sachfiltermatrix sowie positive Google-/Foursquare-Livepfade sind offen; Google lieferte zuletzt 403 und Foursquare 429 mit Cooldown.

**Nächster Abschlussnachweis:** Die exakte reale Bildquote für alle 14 Kategorien und Stays messen und erweitern; anschließend alle 82 Zuordnungen, 19 Landesküchen und Sachfilter auf Desktop und Touch positiv, negativ, leer und bei Providerteilausfall abnehmen und den höchstens drei Sekunden langen Erstaufbau auf physischen iOS-/Android-Geräten bestätigen.
...
App .103 verwendet denselben places.v1-Kandidaten-, Filter-, Passend-, Karten- und Medienweg für Places, Stays, Timeline-Vorschläge und AI Chat. Der öffentliche sichtbare Beleg zeigt Food 48/9 mit strengem vegetarischem Ausschluss und Stays 47/25; erste Pins stehen im Browser nach 1,731 beziehungsweise 1,615 Sekunden bereit. Provider, Lizenz, exakte oder verknüpfte Entitätsreferenz und Verifikationsstatus überleben jetzt Domain- und Plattformprojektion. Die vollständige sichtbare Foto-, Filter- und physische Touchparität in Timeline-Vorschlägen und AI Chat bleibt offen.

**Nächster Abschlussnachweis:** Reale Ortsbildquote und vollständige Filter-/Touchmatrix im gemeinsamen Places Owner schließen und danach dieselben Kandidaten, Sachfilter, Passungsgründe, Medien-, Frische- und Fehlerbelege in Stays, Timeline-Vorschlägen und AI Chat sichtbar abnehmen.
...
App 13.82.168.103 / Core 4.82.222: Runtime-Commit 3d6442c749557711db6d63e2c1fb24e04b84081a, byteidentisches Deployment-Byte-Archiv luvia-integration-13.82.168.103-3d6442c7-public-bytes.zip mit 89.022.652 Bytes und SHA-256 A8784AF164D66E9187FB7A588BB363167E54B8B99D797D92785989F578E41D5F, Gateway v232 / 4.64.35 / Places 4.38.14-cold-hedge-commons-category, Worker 075622ac-defa-4cef-8e20-43684302b7e8, 232/232 Safe Regression, NFR-0 3/3 und 30/30 öffentliche Byteidentität. Sichtbar: Places Food 48/9 ohne Steakhouse-Passung, Stays 47/25 sowie erste nutzbare Pins nach 1,731/1,615 Sekunden. Main und Production unverändert.
