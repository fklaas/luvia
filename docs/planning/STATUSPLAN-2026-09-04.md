...
App .127 bleibt der letzte veröffentlichte Stand. Der neue lokale Quellkandidat übersetzt Freitext über Intelligence in einen zusammenhängenden travelOrder mit Zielraum, Zeitraum, Reisenden und Kindern, Ferienbezug, Unterkunft, Transport, Kategorienmix, Tempo, Ernährung, Zugang, Budget, Freiraum, Muss-Zielen und Ausschlüssen. Reise- und Profilvorlieben steuern danach dieselbe Places-Kandidatenmenge und den vollständigen Tagesentwurf. Unbelegte harte Anforderungen stoppen vor der Places-Recherche; eine dauerhafte Identity-Übernahme erfolgt weiterhin nur nach eigener Bestätigung. 103 Composer-Verhaltensprüfungen sind für diesen Kandidaten grün; Live-Modell, produktive Ferienquelle, Konto-Reload und physische Geräte bleiben offen.
...
App .127 bleibt der letzte veröffentlichte Stand mit drei fachlich getrennten Ergebnissen. Der neue lokale Quellkandidat ergänzt eine eigene trip.compose-Fähigkeit nach semantischem Reiseauftrag und Mehrkategorie-Places-Recherche. Jeder Reisetag muss genau einmal und je nach Tempo mit mindestens zwei, drei oder vier unterschiedlichen echten Places befüllt sein; zu dünne, doppelte, unbekannte oder zeitlich überlappende Modellpläne werden vor der Vorschau verworfen. Die Vorschau zeigt Reise-DNA, das erkannte Reiseverständnis, eine helle interaktive Place-Karte, alle Tage und kontextuelle Uhrzeiten. Ein lokaler Acht-Tage-Ablauf befüllte auch Tag 4 und 8 und schloss 16 simulierte Owner-Schreibaktionen bis zum bestätigten Trip ab. 103 gezielte Composer-Prüfungen, NFR-0 3/3 und die vollständige Safe Regression 238/238 sind grün. Live-Modell, produktive Ferien-/Unterkunfts-/Transportanbieter, Konto-Reload und physische Geräte bleiben offen.
