...
Aktuell öffentlich belegt sind App 13.82.168.100 / Core 4.82.219 auf Integration-Worker 1dcf5de1-c743-4d4c-8d52-40cbac209b03 aus Runtime-Commit b9f32115d75780d9eb76ec03cb31afedf870af94. Gateway v228 meldet 4.64.33 und Places 4.38.11-exact-media-seed-bridge. 30/30 releasekritische Dateien stimmen im sauberen Deployment-Byte-Archiv, auf Stable und auf dem immutable Worker überein. Das byteidentische Archiv luvia-integration-13.82.168.100-b9f32115-public-bytes.zip hat 89.015.942 Bytes und SHA-256 56D8ED1D6F2B92D52F2B8A310921BF7888AB7E0F8F18340D82BB35F868D9C06D. Safe Regression 232/232 und NFR-0 3/3 sind grün. Main und Production bleiben unverändert.
...
Der öffentliche Stand .100 baut auf der .97-OSM-Kontinuität, dem .99-Kategoriencache und der .99-Property-Deduplizierung auf. Er schließt einen Medien-Transportfehler: Die bereits exakt ausgewählte Search-Entität gelangt nun als providerPlaceSeed zum gemeinsamen Detail-Owner, und dessen Cache-Schlüssel trennt bildlose Detailaufrufe von Anfragen mit konkreten Wikidata-, Wikimedia-, Bild- oder Fotobelegen. Der Gateway übernimmt OSM-Medien nur aus dieser exakten Entität; fehlt dort ein Bild, ist höchstens ein Foursquare-Treffer mit streng geprüfter Identität zulässig. Öffentlich zeigt Snykrode dasselbe reale Wikimedia-Ortsbild in Karten-Kurzvorschau, Ergebnis-Sheet und lesbarer Detailansicht mit anklickbarer konkreter Quelldatei. Food Passend bleibt bei neun belegten Treffern ohne Kleines Steakhouse; Shopping Passend zeigt elf, nach echtem Reload erscheinen 46 Pins; Stays zeigt 47 eindeutige Unterkünfte mit Strandgrün und Miramar jeweils einmal. P02 bleibt teilweise, weil viele reale Orte weiterhin keinen sicheren Bildbeleg liefern, die vollständige reale Sachfiltermatrix nicht durchbedient ist und kalte Providerpfade das Drei-Sekunden-Ziel noch nicht durchgehend belegen. Apple bleibt ohne kostenpflichtiges Developer-Programm geparkt.

**Nächster Abschlussnachweis:** Echte Bilder der exakten Provider-Place-ID über eine lizenzierte Quellenkaskade schließen; danach alle 14 Kategorien, 82 Zuordnungen, 19 Landesküchen und sichtbaren Sachfilter auf positive, negative, leere und teilweise Providerfälle abnehmen sowie Cache- und Kaltlatenzen gegen 1,0/3,0 Sekunden messen.
...
App .100 verwendet weiterhin denselben places.v1-Kandidaten- und Passend-Entscheidungsweg für Karte, Timeline und AI Chat. Der neue providerPlaceSeed-Transport und der medienbelegsensitive Detail-Cache liegen im gemeinsamen Detail-Owner; Places und Stays erhalten dadurch dieselbe strenge Bildidentität statt eigener Oberflächenheuristiken. Die öffentliche Places-Karte belegt Food Passend mit neun positiven Treffern ohne Steakhouse-Falschpositiv, Shopping mit elf passenden und 46 Reload-Treffern sowie Snykrode mit einem echten verknüpften Wikimedia-Ortsbild. Stays übernimmt dieselbe Karten-, Pin-, Such-, Passend-, Filter- und Detailtechnik und zeigt 47 eindeutige Unterkünfte. Die vollständige reale Filter-, Foto- und Latenzparität in Timeline-Vorschlägen und AI Chat bleibt Teil des aktiven P02/P03-Abschlusses.

**Nächster Abschlussnachweis:** Die echte Fotoquellenkaskade und sämtliche sichtbaren Filterfälle zunächst im gemeinsamen Places Owner schließen und anschließend dieselben Kandidaten, Passungsgründe, Medien und Frischebelege in Stays, Timeline-Vorschlägen und AI Chat sichtbar abnehmen.
...
App 13.82.168.100 / Core 4.82.219: Runtime-Commit b9f32115d75780d9eb76ec03cb31afedf870af94, byteidentisches Deployment-Byte-Archiv luvia-integration-13.82.168.100-b9f32115-public-bytes.zip mit 89.015.942 Bytes und SHA-256 56D8ED1D6F2B92D52F2B8A310921BF7888AB7E0F8F18340D82BB35F868D9C06D, Gateway v228 / 4.64.33 / Places 4.38.11, Worker 1dcf5de1-c743-4d4c-8d52-40cbac209b03, 232/232 Safe Regression, NFR-0 3/3 und 30/30 öffentliche Byteidentität. Sichtbare Abnahme: Food Passend 9 ohne Steakhouse, Shopping Passend 11, Shopping-Reload 46, Stays 47 ohne doppelte Strandgrün-/Miramar-Properties sowie Snykrode mit exakt verknüpftem Wikimedia-Ortsbild in Kurzkarte, Ergebnis und Detail. Main und Production unverändert.
