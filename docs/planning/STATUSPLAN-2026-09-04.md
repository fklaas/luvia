...
Aktuell öffentlich belegt sind App 13.82.168.99 / Core 4.82.218 auf Integration-Worker 4b32f3a4-c318-4a40-a553-6e95f126875e aus Runtime-Commit b528182e5833cf8715fc3e9f7967bd124c198419. Gateway v227 meldet 4.64.32 und Places 4.38.10-persistent-category-stays-dedupe. 30/30 releasekritische Dateien stimmen im sauberen Deployment-Byte-Archiv, auf Stable und auf dem immutable Worker überein. Das byteidentische Archiv luvia-integration-13.82.168.99-b528182e-public-bytes.zip hat 89.013.269 Bytes und SHA-256 9292403D895286ADC1E49A0179FC598BE845110BED4A606265320D6CCBFB0C4E. Safe Regression 232/232 und NFR-0 3/3 sind grün. Main und Production bleiben unverändert.
...
Der öffentliche Stand .99 baut auf der .97-OSM-Kontinuität für 14 Kategorien und 19 Landesküchen auf. Geladene Kategorieergebnisse werden jetzt pro Reise, Oberfläche, Radius und Kategorie als begrenzte, sachlich projizierte Session-Kohorte gespeichert. Ein Reload zeigte Shopping mit 46 Pins bereits 700 ms nach Abschluss der Navigation; die aktive Shopping-Passung zeigte 11 Treffer. Der sichtbare Wechsel Food → Shopping → Natur → Shopping lieferte jeweils die richtige Kohorte statt eines falschen Leerzustands. Die Gateway-Deduplizierung nutzt gleichen normalisierten Namen plus gleiche vollständige Adresse oder höchstens 25 Meter; nur Unterkünfte mit exakt gleichem Namen erhalten eine erweiterte 350-Meter-Property-Grenze. Der sichtbare Gegenbeleg der Zwischenversion .98 mit zwei Strandgrün- und zwei Miramar-Pins wurde in .99 geschlossen: Stays zeigt 47 eindeutige Pins und beide Namen jeweils einmal. Food Passend zeigt weiterhin neun belegte Treffer und kein Kleines Steakhouse. P02 bleibt teilweise, weil mehrere Detailkarten noch kein exaktes Ortsbild besitzen, die vollständige reale Sachfiltermatrix nicht durchbedient ist und kalte Providerpfade das Drei-Sekunden-Ziel noch nicht durchgehend belegen. Apple bleibt ohne kostenpflichtiges Developer-Programm geparkt.
...
App .99 verwendet weiterhin denselben places.v1-Kandidaten- und Passend-Entscheidungsweg für Karte, Timeline und AI Chat. Der persistente Kategoriencache und die kanonische Property-Deduplizierung liegen in der gemeinsamen Places-/Gateway-Schicht und erzeugen keinen zweiten Consumer-Suchpfad. Die öffentliche Places-Karte belegt Food Passend mit neun positiven Treffern ohne Steakhouse-Falschpositiv sowie korrekte Shopping-Kohorten nach Reload; Stays übernimmt dieselbe Technik und zeigt 47 eindeutige Unterkünfte. Die vollständige reale Filter-, Foto- und Latenzparität in Timeline-Vorschlägen und AI Chat bleibt Teil des aktiven P02/P03-Abschlusses.
...
App 13.82.168.99 / Core 4.82.218: Runtime-Commit b528182e5833cf8715fc3e9f7967bd124c198419, byteidentisches Deployment-Byte-Archiv luvia-integration-13.82.168.99-b528182e-public-bytes.zip mit 89.013.269 Bytes und SHA-256 9292403D895286ADC1E49A0179FC598BE845110BED4A606265320D6CCBFB0C4E, Gateway v227 / 4.64.32, Worker 4b32f3a4-c318-4a40-a553-6e95f126875e, 232/232 Safe Regression, NFR-0 3/3 und 30/30 öffentliche Byteidentität. Sichtbare Abnahme: Food Passend 9 ohne Steakhouse, Shopping Passend 11, Shopping-Reload 46 und Stays 47 ohne doppelte Strandgrün-/Miramar-Properties. Main und Production unverändert.
