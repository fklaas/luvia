...
(()=>{'use strict';window.LuviaKernelVersion=Object.freeze({core:'4.82.168',build:'13.82.168.19',name:'M16.5 Places Category Browse Subject',channel:'integration-preview',builtAt:'2026-09-04T08:00:00.000Z'});window.LuviaCoreVersion=window.LuviaKernelVersion;window.LUVIA_RELEASE=window.LuviaKernelVersion;})();
