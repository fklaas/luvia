...
(()=>{'use strict';window.LuviaKernelVersion=Object.freeze({core:'4.82.285',build:'13.82.168.166',name:'M16.5 Places and Stays Quality',channel:'integration-preview',builtAt:'2026-09-08T15:04:51.000Z'});window.LuviaCoreVersion=window.LuviaKernelVersion;window.LUVIA_RELEASE=window.LuviaKernelVersion;})();
