(() => {
  ...
  const COMPASS_CONTEXTS=Object.freeze({
    ...
    trip:Object.freeze({title:'Wo möchtet ihr eure Reise öffnen?',description:'Tagesdaten, Menschen und Owner-Cores werden nur im passenden Moment sichtbar.',features:Object.freeze([
      feature('Tagesübersicht','Heute und als Nächstes','sun','today'),feature('Timeline','Alle Tage und Momente','calendar','timeline'),feature('Teilnehmer','Rollen, Votes, Einladungen','users','participants','reserved'),feature('Besuchte Orte','Places-Lifecycle','pin','places-lifecycle','foundation'),feature('Live-Momente','Foto, Ton oder Notiz','camera','capture','foundation'),feature('Reisedaten','Ziel, Zeitraum, Reisefarbe','map','trip-settings'),feature('Wallet','Dokumente und Belege offline','wallet','wallet','reserved'),feature('Booking','Status und Antworten','ticket','bookings')
