(() => {
  ...
  const COMPASS_CONTEXTS=Object.freeze({
    ...
    plan:Object.freeze({title:'Welche Richtung soll die Planung nehmen?',description:'Alle Planen-Funktionen bleiben auffindbar; nur die passende Richtung steht im Vordergrund.',features:Object.freeze([
      feature('Places','Suchen, Kategorien, Evidenz','search','places'),feature('Hotels','Unterkünfte, Preise und Buchungswege','home','hotels'),feature('Meine Orte','Gespeichert, geplant, besucht','heart','places-lifecycle','foundation'),feature('Timeline','Ort verbindlich einplanen','calendar','timeline'),feature('Booking','Anfragen, Antworten, Belege','ticket','bookings'),feature('Checklisten','Vorbereitung und unterwegs','check','checklists','reserved'),feature('Budget','Gemeinsame Reiseausgaben','wallet','budget','reserved'),feature('Routen','Etappen und externe Navigation','route','routes','foundation'),feature('Wetter','Kontext statt separater Kachel','cloud','weather','foundation')
