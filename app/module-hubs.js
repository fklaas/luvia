(() => {
  ...
  const COMPASS_CONTEXTS=Object.freeze({
    ...
    trip:Object.freeze({title:'Wo möchtet ihr eure Reise öffnen?',description:'Tagesdaten, Menschen und Erlebnisse werden genau dann sichtbar, wenn sie euch weiterhelfen.',features:Object.freeze([
      feature('Timeline','Alle Tage, Momente und offene Zeitfenster','calendar','timeline'),feature('Teilnehmer','Rollen, Votes, Einladungen','users','participants','reserved'),feature('Besuchte Orte','Places-Lifecycle','pin','places-lifecycle','foundation'),feature('Live-Momente','Foto, Ton oder Notiz','camera','capture','foundation'),feature('Reisedaten','Ziel, Zeitraum, Reisefarbe','map','trip-settings'),feature('Wallet','Dokumente und Belege offline','wallet','wallet','reserved'),feature('Booking','Status und Antworten','ticket','bookings')
