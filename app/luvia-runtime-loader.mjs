...
const ASSET_REVISION = `${BUILD}-split7`;
...
await loadClassic(`./luvia-runtime-precontext-13.82.122.bundle.js?v=${ASSET_REVISION}`);
...
await loadClassic(`./luvia-runtime-postcontext-13.82.122.bundle.js?v=${ASSET_REVISION}`);
