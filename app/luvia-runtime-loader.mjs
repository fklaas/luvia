...
const ASSET_REVISION = `${BUILD}-split8`;
...
await loadClassic(`./luvia-runtime-precontext-13.82.126.bundle.js?v=${ASSET_REVISION}`);
...
await loadClassic(`./luvia-runtime-postcontext-13.82.126.bundle.js?v=${ASSET_REVISION}`);
