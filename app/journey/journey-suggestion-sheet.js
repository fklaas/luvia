  ...
  try{
    ...
    const opened=await booking.commands.openPlaceBooking(place,{
      ...
      onSubmitted:async({booking:submittedBooking,request})=>{
        ...
        completed.set(selectedId,'booking-requested');
