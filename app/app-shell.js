(() => {
  ...
  const BOOKING_AVAILABILITY_SRC='core/booking/booking-availability.js?v=13.68.2';
  const BOOKING_RESERVATION_CREATE_SRC='core/booking/booking-reservation-create.js?v=13.68.2';
  const BOOKING_RESERVATION_MUTATION_SRC='core/booking/booking-reservation-mutation.js?v=13.68.2';
  const BOOKING_RESERVATION_MUTATION_STATUS_SRC='core/booking/booking-reservation-mutation-status.js?v=13.68.2';
  const BOOKING_RESERVATION_RECOVERY_SRC='core/booking/booking-reservation-recovery.js?v=13.68.2';
  const BOOKING_EMAIL_V2_SRC='core/booking/booking-email-v2.js?v=13.68.2';
