(() => {
  ...
  const runtimeAssetUrl=path=>`${path}?v=${encodeURIComponent(window.LuviaKernelVersion?.build||'13.82.98')}`;
  ...
  function profileOnboardingReturnTo(value){
    ...
    return requested!=='profile-onboarding'&&navigationContract().get(requested)?requested:'today';
  }
