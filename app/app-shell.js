(() => {
  ...
  const runtimeAssetUrl=path=>`${path}?v=${encodeURIComponent(window.LuviaKernelVersion?.build||'13.82.116')}`;
  ...
  async function show(view='today',options={}){
    ...
    else if(view==='timeline')content=window.LuviaJourneyDayComposer?.renderTimeline?.(t,esc)||'<section class="lv-error">Die Timeline ist gerade nicht verfügbar.</section>';
