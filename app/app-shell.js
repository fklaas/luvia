(() => {
  ...
  function handleHubAction(action){
    if(!action)return;
    if(['today','plan','trip','memories','more','places','places-lifecycle','routes','gallery','albums','bookings','control-center','control-center-bookings','control-center-inbox'].includes(action))return show(action);
