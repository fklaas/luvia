...
const manifest=Object.freeze({
 id:'control-center',type:'product-surface',version:VERSION,title:'Luvia Control Center',status:'booking-actions-intelligence',defaultEnabled:true,
 ...
 capabilities:Object.freeze(['trip.context','media.gallery','booking.lifecycle','booking.messages','booking.intelligence','booking.actions','notifications.unread','wallet.documents']),
