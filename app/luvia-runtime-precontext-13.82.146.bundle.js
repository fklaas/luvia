...
(()=>{'use strict';window.LuviaKernelVersion=Object.freeze({core:'4.82.146',build:'13.82.146',name:'M16.5 Block 1 Semantic Places Mutations',channel:'integration-preview',builtAt:'2026-09-02T08:58:57.488Z'});window.LuviaCoreVersion=window.LuviaKernelVersion;window.LUVIA_RELEASE=window.LuviaKernelVersion;})();
