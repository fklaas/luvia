(() => {
  ...
  const VERSION = '2.4.1-neutral-stable-world';
  ...
  function mount(host,{onPick=()=>{},onView=()=>{},onNavigate=()=>{},onSettled=()=>{},onIntent=()=>{},view:initial={},selection=null,interactive=true,accent='#c95169',reducedMotion=false}={}){
    ...
    let alive=true,features=[],regions=[],continents=[],d3=null,projection=null,frame=0,flight=0,dragged=false,pinchDistance=0,handledPointer=false,loadSequence=0,selectionChanged=false,transitioning=false,navigationSequence=0,tourSequence=0,zoomBackAt=0;
