...
const legacyBundleRelativePath = 'app/luvia-runtime-13.82.133.bundle.js';
const preContextBundleRelativePath = 'app/luvia-runtime-precontext-13.82.133.bundle.js';
const postContextBundleRelativePath = 'app/luvia-runtime-postcontext-13.82.133.bundle.js';
const bundleMarker = 'data-luvia-runtime-bundle="13.82.133"';
...
if (!indexSource.includes(bundleMarker)) {
  ...
  const insertion = `  <template id="luviaRuntimeSourceManifest" hidden aria-hidden="true">\n${inertManifest}\n  </template>\n  <script type="module" src="app/luvia-runtime-loader.mjs?v=13.82.133-split9" ${bundleMarker}></script>\n`;
