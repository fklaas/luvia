...
function buildReport(validated = validateRegistry()) {
  ...
  return `# M16.5 Human ↔ AI Action Parity Control Plane\n\n` +
    `Date: 2026-09-02\n\n` +
    `Status: **B0.01–B0.10 PUBLIC COMPLETE ON 13.82.135 / B1 FOUNDATION PUBLIC ON 13.82.136 + TRIP READ ON 13.82.138 + PLACES MUTATIONS ON 13.82.139 + BOOKING LIFECYCLE/PLACE-ROUTE INTEGRITY ON 13.82.143 / RECOVERY BASELINE ON 13.82.147 / 13.82.148–149 REJECTED / CONTINUOUS-MAP CANDIDATE ON 13.82.156 / PRODUCT PARITY CONTINUES THROUGH B1–B5**\n\n` +
