...
function buildReport(validated = validateRegistry()) {
  ...
  return `# M16.5 Human ↔ AI Action Parity Control Plane\n\n` +
    `Date: 2026-09-02\n\n` +
    `Status: **B0.01–B0.10 PUBLIC COMPLETE ON 13.82.135 / B1 FOUNDATION PUBLIC ON 13.82.136 + TRIP READ ON 13.82.138 + PLACES MUTATIONS ON 13.82.139 + BOOKING LIFECYCLE/PLACE-ROUTE INTEGRITY ON 13.82.143 / STABLE RECOVERY ON 13.82.147 / 13.82.148 REJECTED / LIVE-VIEWPORT CANDIDATE ON 13.82.149 / PRODUCT PARITY CONTINUES THROUGH B1–B5**\n\n` +
    ...
    `5. Preserve the publicly closed B0.10 control-plane release and continue product parity row by row through B1–B5. App \`13.82.135\` proved one exact Plan/Undo path, accepted App \`13.82.138\` proved the Chat-native Trip-selection read, accepted App \`13.82.139\` publicly proved the complete Favorite/Unfavorite/Plan/Unplan confirmation, readback, receipt and Undo protocol, and accepted App \`13.82.143\` proved the Booking lifecycle plus exact Place-route gate. Stable App \`13.82.147\` retains the recovery baseline, App \`13.82.148\` is rejected counterevidence, and App \`13.82.149\` is the local one-pin/one-entity and live-viewport candidate; provider-positive public evidence remains open.\n\n` +
    ...
    `locally green; the 330-row parity/failure matrix remains a release gate for every following domain slice. Accepted App \`13.82.139\` promotes exactly four publicly operated Places mutation rows for seven total public passes. The rejected \`.148\` and local \`.149\` viewport candidates do not inflate public evidence before an operated public run.\n`;
}
