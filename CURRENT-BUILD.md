...
Release-Kandidat: **13.82.168.100**, Core **4.82.219**, Channel **integration-preview**, Runtime-Familie **M16.5 Places and Stays Quality**. Der Kandidat trägt die exakte ausgewählte Provider-Entität aus Places und Stays bis zum gemeinsamen Detail-Owner, trennt Detail-Caches nach diesem Medienbeleg und darf OpenStreetMap-Medien nur über verknüpfte Wikidata-/Wikimedia-Daten oder einen streng identitätsgeprüften Foursquare-Treffer ergänzen. Öffentlich bleibt bis zur abgeschlossenen Ausspielung **13.82.168.99 / 4.82.218** mit Runtime-Commit **b528182e5833cf8715fc3e9f7967bd124c198419**, Gateway **v227 / 4.64.32 / Places 4.38.10** und Worker **4b32f3a4-c318-4a40-a553-6e95f126875e**. Dessen sichtbare Belege bleiben Food `Passend 9` ohne Kleines Steakhouse, Shopping `Passend 11`, ein Shopping-Reload mit 46 Pins und Stays mit 47 eindeutigen Pins. Safe Regression **232/232**, NFR-0 **3/3** und **30/30** Byteidentität sind belegt. Main und Production bleiben unverändert.
