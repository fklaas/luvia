...
Öffentliche Integration: **13.82.168.99**, Core **4.82.218**, Channel **integration-preview**, Runtime-Familie **M16.5 Places and Stays Quality**. `places.v1` entscheidet die belegte Passung weiterhin einmalig für Karte, Timeline und AI Chat. Der veröffentlichte Stand hält begrenzte Kategorie-Kohorten pro Reise, Oberfläche, Radius und Kategorie in der Session, nutzt sie nach Reload sofort und aktualisiert anschließend im Hintergrund. Allgemeine Dubletten werden nur bei gleichem Namen plus gleicher vollständiger Adresse oder höchstens 25 Metern zusammengeführt; Unterkünfte mit exakt gleichem Namen dürfen bis 350 Meter als eine Property kanonisiert werden. Runtime-Commit **b528182e5833cf8715fc3e9f7967bd124c198419**, Gateway **v227 / 4.64.32 / Places 4.38.10** und Worker **4b32f3a4-c318-4a40-a553-6e95f126875e** bilden den öffentlichen Stand. Sichtbar belegt sind Food `Passend 9` ohne Kleines Steakhouse, Shopping `Passend 11`, ein Shopping-Reload mit 46 Pins und Stays mit 47 eindeutigen Pins. Safe Regression **232/232**, NFR-0 **3/3** und **30/30** Byteidentität zwischen sauberem Deployment-Archiv, Stable und immutable Worker sind belegt. Main und Production bleiben unverändert.
