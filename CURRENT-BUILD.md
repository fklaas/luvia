...
- Local evidence: **focused map, exact-selection, clean-detail, Booking-lifecycle, Hotel-owner and Places-category gates are green. The complete controlled regression, immutable Integration deployment and operated mobile acceptance remain release requirements**.
