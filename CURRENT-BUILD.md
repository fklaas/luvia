...
Veröffentlicht **13.82.168.49**, Core **4.82.171**, Channel **integration-preview**, Runtime-Familie **M16.5 Places and Stays Quality**: wahrheitsgemäßer Timeline-First-Paint, parallele Owner-Reads und eine sichtbare Fähigkeitsmatrix für Place-Pläne, Buchungen, bestätigte Besuche und Memories. **.48** bleibt der direkte getestete Code-Rückfallstand.
