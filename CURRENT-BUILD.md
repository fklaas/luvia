...
Release-Kandidat für Integration: **13.82.168.70**, Core **4.82.192**, Channel **integration-preview**, Runtime-Familie **M16.5 Places and Stays Quality**. Alle 19 sichtbaren Landesküchen besitzen denselben diagnostizierbaren 5-km-Vertrag wie die reale App. Ein verständlicher Nullfall bietet anschließend ausschließlich auf bewussten Nutzerklick eine 10-km-Suche einschließlich Umgebung an; Kategorie- oder Modulwechsel stellen den normalen Reisezielradius wieder her. Eine kleinere, wegen Provider-Drosselung unvollständige Fallback-Menge verdrängt keinen vollständigen, höchstens 15 Minuten alten Ortsbestand und wird nur 30 Sekunden zwischengespeichert. Timeline-Vorschläge verwenden weiterhin dieselbe `places.v1`-Kartenprojektion wie Places und Stays. Gateway **v185** ist auf Integration aktiv; Datenbank, Secrets, Main und Production bleiben unverändert.
