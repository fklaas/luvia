...
- Registry truth: **329 semantic actions, 23 typed runtime actions, 124 protected mutations, 20 truthful Undo paths, 899 audited source markers and 2,725 generated failure evals remain active. Provider-positive public evidence is not inferred from controlled local transports**.
