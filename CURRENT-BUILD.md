...
- Public status: **App 13.82.63 is deployed but superseded and not functionally accepted because the visible public Places-return sequence exposed the route-host replay. App 13.82.64 publication and a complete new visible public touch sequence are pending; physical handset retest remains explicitly open even after automated hardware-path evidence**.
