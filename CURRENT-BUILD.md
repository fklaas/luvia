...
- Remaining B1 boundary: **continue now in the fixed order with Booking Read/Open/Create/Modify/Cancel, provider-positive ticket/reservation routes, Hotel/provider activation, P09/P10 and the remaining Step-17 hardware/provider rows; Blocks 2–5 remain queued in their binding order**.
