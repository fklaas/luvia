...
- Status: **Compass-first public journey candidate complete; the reduced critical-worker install, exact-build cache delivery, immutable publication and exact deployed-byte E2E are in verification. This is not the complete M16.5 Product-Surface or Design-Freeze acceptance**.
