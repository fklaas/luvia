...
assert.equal(api.runtimeVersion,'1.13.0-complete-trip-composition');assert.equal(typeof api.reads.evaluateHumanActionAuthority,'function');assert.equal(typeof api.reads.getHumanActionSafetyCoverage,'function');
