...
assert.equal(api.runtimeVersion,'1.18.0-scalable-trip-place-catalog');assert.equal(typeof api.reads.evaluateHumanActionAuthority,'function');assert.equal(typeof api.reads.getHumanActionSafetyCoverage,'function');
