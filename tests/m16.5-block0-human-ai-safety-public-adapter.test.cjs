...
assert.equal(api.runtimeVersion,'1.18.1-duration-scaled-trip-place-paging');assert.equal(typeof api.reads.evaluateHumanActionAuthority,'function');assert.equal(typeof api.reads.getHumanActionSafetyCoverage,'function');
