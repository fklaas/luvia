...
assert.equal(api.runtimeVersion,'1.15.0-verified-travel-calendar');assert.equal(typeof api.reads.evaluateHumanActionAuthority,'function');assert.equal(typeof api.reads.getHumanActionSafetyCoverage,'function');
