...
assert.equal(api.runtimeVersion,'1.16.0-semantic-travel-windows');assert.equal(typeof api.reads.evaluateHumanActionAuthority,'function');assert.equal(typeof api.reads.getHumanActionSafetyCoverage,'function');
