...
assert.equal(api.runtimeVersion,'1.14.0-semantic-trip-quality');assert.equal(typeof api.reads.evaluateHumanActionAuthority,'function');assert.equal(typeof api.reads.getHumanActionSafetyCoverage,'function');
