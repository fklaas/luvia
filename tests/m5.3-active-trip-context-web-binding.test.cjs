...
async function main() {
  ...
  assert.ok(
    binding.includes(
      "./core/trips/active-trip-context.mjs?v=13.82.142"
    ),
  ...
  assert.strictEqual(
    count(
      index,
      '<script type="module" src="luvia-trip-context.js?v=13.82.142"></script>'
    ),
    1,
  ...
  assert.strictEqual(
    count(
      index,
      '<script src="luvia-trip-context.js?v=13.82.142"></script>'
    ),
    0,
  ...
  const preIndex = loader.indexOf('luvia-runtime-precontext-13.82.142.bundle.js');
  const tripContextIndex = loader.indexOf('../luvia-trip-context.js');
  const postIndex = loader.indexOf('luvia-runtime-postcontext-13.82.142.bundle.js');
