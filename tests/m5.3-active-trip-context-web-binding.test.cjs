...
async function main() {
  ...
  assert.ok(
    binding.includes(
      "./core/trips/active-trip-context.mjs?v=13.82.168.128"
    ),
  ...
  assert.strictEqual(
    count(
      index,
      '<script type="module" src="luvia-trip-context.js?v=13.82.168.128"></script>'
    ),
    1,
  ...
  assert.strictEqual(
    count(
      index,
      '<script src="luvia-trip-context.js?v=13.82.168.128"></script>'
    ),
    0,
