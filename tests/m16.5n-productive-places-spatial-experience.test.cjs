...
assert.match(experience,/strictPlaceType:evidenceType[\s\S]{0,500}providers:\['geoapify','here','google','foursquare'\]/,'only the explicit profile-evidence read may start free Geoapify\/OSM, then HERE and the bounded exact-evidence providers after the retained cohort could not prove a fit');
