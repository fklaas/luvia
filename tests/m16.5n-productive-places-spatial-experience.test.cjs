...
assert.match(experience,/strictPlaceType:evidenceType[\s\S]{0,500}providers:\['google','foursquare'\]/,'only the explicit profile-evidence read may start the bounded exact-evidence providers after the retained free cohort could not prove a fit');
