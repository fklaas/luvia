...
assert.match(experience,/strictPlaceType:evidenceType[\s\S]{0,500}providers:\['here','google','foursquare'\]/,'only the explicit profile-evidence read may start the free-first and bounded exact-evidence providers after the retained cohort could not prove a fit');
