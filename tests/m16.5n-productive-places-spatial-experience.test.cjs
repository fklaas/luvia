...
assert.match(experience,/consumer:places-spatial:v9-persistent-category-continuity/,'offline Places cache must version persistent per-category owner cohorts');
