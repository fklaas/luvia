...
assert.match(rendered,/<p class="lvt-focus-greeting">(?:Guten Morgen|Guten Tag|Guten Abend|Gute Nacht), Fabian\.<\/p><h1 id="lvt-title">Heute gehört <em>Paris<\/em> euch\.<\/h1>/);
