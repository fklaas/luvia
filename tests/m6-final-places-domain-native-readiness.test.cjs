...
assert.deepStrictEqual(JSON.parse(JSON.stringify(core.routeDiscovery({category:'nature'}))),{
  category:'nature',label:'Natur & Erholung',primaryType:'nature',domainTypes:['nature','activity'],includedType:'park',includedTypes:['park','garden','beach','hiking_area','natural_feature'],excludedTypes:['store','hospital','lodging','accommodation','hotel','hostel','motel','guest_house','bed_and_breakfast','apartment','vacation_rental','holiday_home','resort_hotel','campground','spa'],query:'Parks Gärten Natur Erholung'
});
