...
assert.equal(manifest.currentBuild,'13.82.161');
...
assert.match(loader,/luvia-runtime-precontext-13\.82\.161\.bundle\.js/);
assert.match(loader,/luvia-runtime-postcontext-13\.82\.161\.bundle\.js/);
...
assert.match(worker,/luvia-runtime-precontext-13\.82\.161\.bundle\.js/);
