...
assert.equal(manifest.currentBuild,'13.82.153');
...
assert.match(loader,/luvia-runtime-precontext-13\.82\.153\.bundle\.js/);
assert.match(loader,/luvia-runtime-postcontext-13\.82\.153\.bundle\.js/);
...
assert.match(worker,/luvia-runtime-precontext-13\.82\.153\.bundle\.js/);
