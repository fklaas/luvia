...
assert.equal(manifest.currentBuild,'13.82.136');
...
assert.match(loader,/luvia-runtime-precontext-13\.82\.136\.bundle\.js/);
assert.match(loader,/luvia-runtime-postcontext-13\.82\.136\.bundle\.js/);
assert.doesNotMatch(loader,/13\.82\.(?:12[1-9]|130)\.bundle\.js/,'the current loader may not execute a compatibility bundle');
assert.match(worker,/luvia-runtime-precontext-13\.82\.136\.bundle\.js/);
