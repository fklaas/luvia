...
assert.strictEqual(actual.summary.css.bytes, 1235198, 'M16.5 canonical LF CSS baseline byte count changed unexpectedly');
...
assert.strictEqual(actual.summary.css.zIndexDeclarations, 434, 'M16.5 z-index baseline changed unexpectedly');
