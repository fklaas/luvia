...
assert.strictEqual(actual.summary.css.bytes, 1555743, 'M16.5 canonical LF CSS baseline byte count changed unexpectedly');
assert.strictEqual(actual.summary.css.important, 3778, 'M16.5 !important baseline changed unexpectedly');
assert.strictEqual(actual.summary.css.literalHexColours, 4061, 'M16.5 literal colour baseline changed unexpectedly');
