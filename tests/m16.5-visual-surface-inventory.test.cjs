...
assert.strictEqual(actual.summary.css.bytes, 1725720, 'M16.5 canonical LF CSS baseline byte count changed unexpectedly');
assert.strictEqual(actual.summary.css.important, 3932, 'M16.5 !important baseline changed unexpectedly');
assert.strictEqual(actual.summary.css.literalHexColours, 4679, 'M16.5 literal colour baseline changed unexpectedly');
assert.strictEqual(actual.summary.css.zIndexDeclarations, 552, 'M16.5 z-index baseline changed unexpectedly');
