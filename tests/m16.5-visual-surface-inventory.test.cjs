...
assert.strictEqual(actual.summary.css.bytes, 1595236, 'M16.5 canonical LF CSS baseline byte count changed unexpectedly');
assert.strictEqual(actual.summary.css.important, 3923, 'M16.5 !important baseline changed unexpectedly');
assert.strictEqual(actual.summary.css.literalHexColours, 4180, 'M16.5 literal colour baseline changed unexpectedly');
