...
assert.strictEqual(actual.summary.css.bytes, 1333336, 'M16.5 canonical LF CSS baseline byte count changed unexpectedly');
...
assert.strictEqual(actual.summary.css.zIndexDeclarations, 470, 'M16.5 z-index baseline changed unexpectedly');
