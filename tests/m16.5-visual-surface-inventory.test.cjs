...
assert.strictEqual(actual.summary.css.bytes, 1396258, 'M16.5 canonical LF CSS baseline byte count changed unexpectedly');
assert.strictEqual(actual.summary.css.important, 3691, 'M16.5 !important baseline changed unexpectedly');
assert.strictEqual(actual.summary.css.literalHexColours, 3723, 'M16.5 literal colour baseline changed unexpectedly');
