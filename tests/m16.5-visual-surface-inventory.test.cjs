...
assert.strictEqual(actual.summary.css.bytes, 1592744, 'M16.5 canonical LF CSS baseline byte count changed unexpectedly');
assert.strictEqual(actual.summary.css.important, 3901, 'M16.5 !important baseline changed unexpectedly');
assert.strictEqual(actual.summary.css.literalHexColours, 4153, 'M16.5 literal colour baseline changed unexpectedly');
assert.strictEqual(actual.summary.css.zIndexDeclarations, 506, 'M16.5 z-index baseline changed unexpectedly');
