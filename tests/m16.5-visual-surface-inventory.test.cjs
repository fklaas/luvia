...
assert.strictEqual(actual.summary.css.bytes, 838366, 'M16.5 canonical LF CSS baseline byte count changed unexpectedly');
...
assert.strictEqual(actual.summary.css.zIndexDeclarations, 228, 'M16.5 z-index baseline changed unexpectedly');
