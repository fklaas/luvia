...
assert.strictEqual(actual.summary.css.bytes, 1755304, 'M16.5 canonical LF CSS baseline byte count changed unexpectedly');
assert.strictEqual(actual.summary.css.important, 3934, 'M16.5 !important baseline changed unexpectedly');
assert.strictEqual(actual.summary.css.literalHexColours, 4850, 'M16.5 literal colour baseline changed unexpectedly');
assert.strictEqual(actual.summary.css.zIndexDeclarations, 566, 'M16.5 z-index baseline changed unexpectedly');
