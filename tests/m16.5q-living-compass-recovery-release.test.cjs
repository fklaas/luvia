...
for(const asset of ['intelligence/kernel/version.js','intelligence/pwa-service.js','app/app-shell.js','app/module-hubs.js','app/module-hubs.css','app/places/places-spatial-experience.js','app/places/places-spatial-experience.css'])assert.ok(index.includes(`${asset}?v=13.82.64`),`M16.5Q cache key missing for ${asset}`);
...
console.log('App / Core / shell cache: 13.82.64 / 4.82.64 / luvia-shell-v13.82.64');
