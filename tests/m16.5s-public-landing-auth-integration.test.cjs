...
assert.match(index, /app\/public-landing\.css\?v=13\.82\.168\.62" data-luvia-public-landing-style disabled/);
assert.match(index, /app\/public-landing-experience-motion\.css\?v=13\.82\.168\.62" data-luvia-public-landing-style disabled/);
assert.ok(index.indexOf('app/public-landing-motion.js?v=13.82.168.62') < index.indexOf('app/public-entry.js?v=13.82.168.62'));
assert.ok(index.indexOf('app/public-landing-experience-motion.js?v=13.82.168.62') < index.indexOf('app/public-entry.js?v=13.82.168.62'));
