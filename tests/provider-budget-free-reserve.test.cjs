...
assert.match(places,/version:'4\.38\.9-persistent-category-canonical-dedupe'/,'the deployed gateway must identify the active cached category and dietary evidence contract');
