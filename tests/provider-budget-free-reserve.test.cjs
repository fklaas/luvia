...
assert.match(places,/version:'4\.38\.13-specialty-type-purity'/,'the deployed gateway must identify the active provider, exact-media and specialty-type contract');
