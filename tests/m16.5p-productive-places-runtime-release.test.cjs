...
assert.match(worker,/const CACHE='luvia-shell-v13\.82\.127(?:-runtime\d+)?'/);
...
assert.match(index,/vendor\/maplibre\/maplibre-gl-5\.12\.0\.css\?v=13\.82\.127/);
assert.match(index,/vendor\/maplibre\/maplibre-gl-5\.12\.0\.js\?v=13\.82\.127/);
for(const asset of [
  'app/places/places-spatial-composition-core.js',
  'app/places/places-spatial-experience.js',
  'app/places/places-spatial-experience.css'
