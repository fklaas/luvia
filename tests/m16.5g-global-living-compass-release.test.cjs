...
assert.ok(index.includes('app/app-shell.js?v=13.82.81'));
assert.ok(index.includes('app/today/today-experience.js?v=13.82.81'));
assert.ok(index.includes('core/experience/experience-contract-core.js?v=13.82.81'));
