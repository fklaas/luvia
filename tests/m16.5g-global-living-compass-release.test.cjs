...
assert.match(worker,/const CACHE='luvia-shell-v13\.82\.157'/);
assert.equal(index.includes('?v=13.82.49'),false,'active entry must not retain the previous runtime cache key');
assert.ok(index.includes('app/app-shell.js?v=13.82.157'));
assert.ok(index.includes('app/today/today-experience.js?v=13.82.157'));
assert.ok(index.includes('core/experience/experience-contract-core.js?v=13.82.157'));
