...
assert.equal(contract.runtimeVersion,'1.14.1-deterministic-navigation-first');
for(const prompt of [
...
assert.match(fs.readFileSync(path.resolve(__dirname,'../core/ai/ai-action-runtime.js'),'utf8'),/const VERSION='1\.21\.1-deterministic-navigation-first'/);
