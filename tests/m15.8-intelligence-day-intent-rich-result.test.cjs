...
assert.equal(contract.runtimeVersion,'1.16.0-visit-owner-commands');
for(const prompt of [
...
assert.match(fs.readFileSync(path.resolve(__dirname,'../core/ai/ai-action-runtime.js'),'utf8'),/const VERSION='1\.23\.6-explicit-duplicate-visit-selection'/);
