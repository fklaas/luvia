...
assert.equal(contract.runtimeVersion,'1.15.0-journey-owner-commands');
for(const prompt of [
...
assert.match(fs.readFileSync(path.resolve(__dirname,'../core/ai/ai-action-runtime.js'),'utf8'),/const VERSION='1\.22\.0-journey-owner-commands'/);
