...
assert.equal(contract.runtimeVersion,'1.17.0-route-buffer-confirmation');
for(const prompt of [
...
assert.match(fs.readFileSync(path.resolve(__dirname,'../core/ai/ai-action-runtime.js'),'utf8'),/const VERSION='1\.26\.0-owner-readback-reconciliation'/);
