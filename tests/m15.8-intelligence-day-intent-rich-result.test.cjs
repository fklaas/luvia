...
assert.equal(contract.runtimeVersion,'1.14.0-selected-stay-offer-action');
for(const prompt of [
...
assert.match(fs.readFileSync(path.resolve(__dirname,'../core/ai/ai-action-runtime.js'),'utf8'),/const VERSION='1\.20\.0-semantic-booking-requirement-and-stay-offer'/);
