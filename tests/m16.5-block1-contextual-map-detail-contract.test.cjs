...
assert.match(placesCore,/preferredMarkers:'all-positive-evidence-backed-non-conflicting-results'/,'every positive evidence-backed non-conflicting match must remain visible in Passend mode');
