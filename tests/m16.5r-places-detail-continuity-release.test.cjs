...
assert.match(version,/core:'4\.82\.141',build:'13\.82\.141'/);
...
])assert(index.includes(`${asset}?v=13.82.141`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.141'"));
...
console.log('App / Core / shell cache: 13.82.141 / 4.82.141 / luvia-shell-v13.82.141');
