...
assert.match(version,/core:'4\.82\.123',build:'13\.82\.123'/);
...
])assert(index.includes(`${asset}?v=13.82.123`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.123'"));
...
console.log('App / Core / shell cache: 13.82.123 / 4.82.123 / luvia-shell-v13.82.123');
