...
assert.match(version,/core:'4\.82\.144',build:'13\.82\.144'/);
...
])assert(index.includes(`${asset}?v=13.82.144`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.144'"));
...
console.log('App / Core / shell cache: 13.82.144 / 4.82.144 / luvia-shell-v13.82.144');
