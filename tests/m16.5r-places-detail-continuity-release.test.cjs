...
assert.match(version,/core:'4\.82\.66',build:'13\.82\.66'/);
...
])assert(index.includes(`${asset}?v=13.82.66`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.66'"));
...
console.log('App / Core / shell cache: 13.82.66 / 4.82.66 / luvia-shell-v13.82.66');
