...
assert.match(version,/core:'4\.82\.73',build:'13\.82\.73'/);
...
])assert(index.includes(`${asset}?v=13.82.73`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.73'"));
...
console.log('App / Core / shell cache: 13.82.73 / 4.82.73 / luvia-shell-v13.82.73');
