...
assert.ok(version.includes("core:'4.82.234'")&&version.includes("build:'13.82.168.115'"),'kernel build must be the geoapify cache-bust release');
...
])assert(index.includes(`${asset}?v=13.82.168.115`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.168.115-local-recovery'"));
...
console.log('App / Core / shell cache: 13.82.168.115 / 4.82.234 / luvia-shell-v13.82.168.115-local-recovery');
