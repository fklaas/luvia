...
assert.match(version,/core:'4\.82\.97',build:'13\.82\.97'/);
...
])assert(index.includes(`${asset}?v=13.82.97`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.97'"));
...
console.log('App / Core / shell cache: 13.82.97 / 4.82.97 / luvia-shell-v13.82.97');
