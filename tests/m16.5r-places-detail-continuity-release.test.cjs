...
assert.match(version,/core:'4\.82\.83',build:'13\.82\.83'/);
...
])assert(index.includes(`${asset}?v=13.82.83`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.83'"));
...
console.log('App / Core / shell cache: 13.82.83 / 4.82.83 / luvia-shell-v13.82.83');
