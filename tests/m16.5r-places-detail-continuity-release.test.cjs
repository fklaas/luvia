...
assert.match(version,/core:'4\.82\.157',build:'13\.82\.157'/);
...
])assert(index.includes(`${asset}?v=13.82.157`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.157'"));
...
console.log('App / Core / shell cache: 13.82.157 / 4.82.157 / luvia-shell-v13.82.157');
