...
assert.match(version,/core:'4\.82\.137',build:'13\.82\.137'/);
...
])assert(index.includes(`${asset}?v=13.82.137`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.137'"));
...
console.log('App / Core / shell cache: 13.82.137 / 4.82.137 / luvia-shell-v13.82.137');
