...
assert.match(version,/core:'4\.82\.122',build:'13\.82\.122'/);
...
])assert(index.includes(`${asset}?v=13.82.122`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.122'"));
...
console.log('App / Core / shell cache: 13.82.122 / 4.82.122 / luvia-shell-v13.82.122');
