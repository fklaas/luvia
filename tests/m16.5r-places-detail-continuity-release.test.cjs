...
])assert(index.includes(`${asset}?v=13.82.92`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.92'"));
...
console.log('App / Core / shell cache: 13.82.92 / 4.82.92 / luvia-shell-v13.82.92');
