...
assert.match(version,/core:'4\.82\.139',build:'13\.82\.139'/);
...
])assert(index.includes(`${asset}?v=13.82.139`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.139'"));
...
console.log('App / Core / shell cache: 13.82.139 / 4.82.139 / luvia-shell-v13.82.139');
