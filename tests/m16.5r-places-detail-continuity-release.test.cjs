...
assert.match(version,/core:'4\.82\.149',build:'13\.82\.149'/);
...
])assert(index.includes(`${asset}?v=13.82.149`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.149'"));
...
console.log('App / Core / shell cache: 13.82.149 / 4.82.149 / luvia-shell-v13.82.149');
