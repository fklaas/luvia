...
assert.match(version,/core:'4\.82\.124',build:'13\.82\.124'/);
...
])assert(index.includes(`${asset}?v=13.82.124`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.124'"));
...
console.log('App / Core / shell cache: 13.82.124 / 4.82.124 / luvia-shell-v13.82.124');
