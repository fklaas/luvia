...
assert.match(version,/core:'4\.82\.98',build:'13\.82\.98'/);
...
])assert(index.includes(`${asset}?v=13.82.98`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.98'"));
...
console.log('App / Core / shell cache: 13.82.98 / 4.82.98 / luvia-shell-v13.82.98');
