...
assert.match(version,/core:'4\.82\.107',build:'13\.82\.107'/);
...
])assert(index.includes(`${asset}?v=13.82.107`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.107'"));
...
console.log('App / Core / shell cache: 13.82.107 / 4.82.107 / luvia-shell-v13.82.107');
