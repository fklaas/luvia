...
assert.match(version,/core:'4\.82\.125',build:'13\.82\.125'/);
...
])assert(index.includes(`${asset}?v=13.82.125`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.125'"));
...
console.log('App / Core / shell cache: 13.82.125 / 4.82.125 / luvia-shell-v13.82.125');
