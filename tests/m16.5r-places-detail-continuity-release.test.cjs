...
assert.match(version,/core:'4\.82\.158',build:'13\.82\.158'/);
...
])assert(index.includes(`${asset}?v=13.82.158`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.158'"));
...
console.log('App / Core / shell cache: 13.82.158 / 4.82.158 / luvia-shell-v13.82.158');
