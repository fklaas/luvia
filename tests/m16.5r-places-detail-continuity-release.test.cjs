...
assert.match(version,/core:'4\.82\.126',build:'13\.82\.126'/);
...
])assert(index.includes(`${asset}?v=13.82.126`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.126'"));
...
console.log('App / Core / shell cache: 13.82.126 / 4.82.126 / luvia-shell-v13.82.126');
