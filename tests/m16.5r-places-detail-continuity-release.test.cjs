...
assert.match(version,/core:'4\.82\.81',build:'13\.82\.81'/);
...
])assert(index.includes(`${asset}?v=13.82.81`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.81'"));
...
console.log('App / Core / shell cache: 13.82.81 / 4.82.81 / luvia-shell-v13.82.81');
