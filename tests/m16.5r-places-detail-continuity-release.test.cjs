...
assert.match(version,/core:'4\.82\.151',build:'13\.82\.151'/);
...
])assert(index.includes(`${asset}?v=13.82.151`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.151'"));
...
console.log('App / Core / shell cache: 13.82.151 / 4.82.151 / luvia-shell-v13.82.151');
