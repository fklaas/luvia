...
assert.match(version,/core:'4\.82\.87',build:'13\.82\.87'/);
...
])assert(index.includes(`${asset}?v=13.82.87`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.87'"));
...
console.log('App / Core / shell cache: 13.82.87 / 4.82.87 / luvia-shell-v13.82.87');
