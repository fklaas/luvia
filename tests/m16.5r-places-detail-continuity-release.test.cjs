...
assert.match(version,/core:'4\.82\.160',build:'13\.82\.160'/);
...
])assert(index.includes(`${asset}?v=13.82.160`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.160'"));
...
console.log('App / Core / shell cache: 13.82.160 / 4.82.160 / luvia-shell-v13.82.160');
