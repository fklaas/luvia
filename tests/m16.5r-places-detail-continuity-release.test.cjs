...
assert.match(version,/core:'4\.82\.138',build:'13\.82\.138'/);
...
])assert(index.includes(`${asset}?v=13.82.138`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.138'"));
...
console.log('App / Core / shell cache: 13.82.138 / 4.82.138 / luvia-shell-v13.82.138');
