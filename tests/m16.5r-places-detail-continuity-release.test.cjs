...
assert.match(version,/core:'4\.82\.142',build:'13\.82\.142'/);
...
])assert(index.includes(`${asset}?v=13.82.142`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.142'"));
...
console.log('App / Core / shell cache: 13.82.142 / 4.82.142 / luvia-shell-v13.82.142');
