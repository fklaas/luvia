...
assert.match(version,/core:'4\.82\.68',build:'13\.82\.68'/);
...
])assert(index.includes(`${asset}?v=13.82.68`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.68'"));
...
console.log('App / Core / shell cache: 13.82.68 / 4.82.68 / luvia-shell-v13.82.68');
