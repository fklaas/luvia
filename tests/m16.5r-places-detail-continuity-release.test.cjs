...
assert.match(version,/core:'4\.82\.130',build:'13\.82\.130'/);
...
])assert(index.includes(`${asset}?v=13.82.130`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.130'"));
...
console.log('App / Core / shell cache: 13.82.130 / 4.82.130 / luvia-shell-v13.82.130');
