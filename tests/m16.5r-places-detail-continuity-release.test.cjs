...
assert.match(version,/core:'4\.82\.128',build:'13\.82\.128'/);
...
])assert(index.includes(`${asset}?v=13.82.128`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.128'"));
...
console.log('App / Core / shell cache: 13.82.128 / 4.82.128 / luvia-shell-v13.82.128');
