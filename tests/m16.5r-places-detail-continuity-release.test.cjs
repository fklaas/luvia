...
assert.match(version,/core:'4\.82\.105',build:'13\.82\.105'/);
...
])assert(index.includes(`${asset}?v=13.82.105`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.105'"));
...
console.log('App / Core / shell cache: 13.82.105 / 4.82.105 / luvia-shell-v13.82.105');
