...
assert.match(version,/core:'4\.82\.145',build:'13\.82\.145'/);
...
])assert(index.includes(`${asset}?v=13.82.145`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.145'"));
...
console.log('App / Core / shell cache: 13.82.145 / 4.82.145 / luvia-shell-v13.82.145');
