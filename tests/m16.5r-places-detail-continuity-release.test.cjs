...
assert.match(version,/core:'4\.82\.152',build:'13\.82\.152'/);
...
])assert(index.includes(`${asset}?v=13.82.152`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.152'"));
...
console.log('App / Core / shell cache: 13.82.152 / 4.82.152 / luvia-shell-v13.82.152');
