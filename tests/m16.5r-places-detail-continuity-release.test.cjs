...
assert.match(version,/core:'4\.82\.99',build:'13\.82\.99'/);
...
])assert(index.includes(`${asset}?v=13.82.99`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.99'"));
...
console.log('App / Core / shell cache: 13.82.99 / 4.82.99 / luvia-shell-v13.82.99');
