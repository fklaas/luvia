...
assert.match(version,/core:'4\.82\.153',build:'13\.82\.153'/);
...
])assert(index.includes(`${asset}?v=13.82.153`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.153'"));
...
console.log('App / Core / shell cache: 13.82.153 / 4.82.153 / luvia-shell-v13.82.153');
