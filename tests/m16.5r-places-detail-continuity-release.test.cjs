...
assert.match(version,/core:'4\.82\.132',build:'13\.82\.132'/);
...
])assert(index.includes(`${asset}?v=13.82.132`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.132'"));
...
console.log('App / Core / shell cache: 13.82.132 / 4.82.132 / luvia-shell-v13.82.132');
