...
assert.match(version,/core:'4\.82\.71',build:'13\.82\.71'/);
...
])assert(index.includes(`${asset}?v=13.82.71`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.71'"));
