...
assert.match(version,/core:'4\.82\.67',build:'13\.82\.67'/);
...
])assert(index.includes(`${asset}?v=13.82.67`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.67'"));
...
console.log('App / Core / shell cache: 13.82.67 / 4.82.67 / luvia-shell-v13.82.67');
