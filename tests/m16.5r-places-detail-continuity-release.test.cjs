...
assert.match(version,/core:'4\.82\.94',build:'13\.82\.94'/);
...
])assert(index.includes(`${asset}?v=13.82.94`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.94'"));
...
console.log('App / Core / shell cache: 13.82.94 / 4.82.94 / luvia-shell-v13.82.94');
