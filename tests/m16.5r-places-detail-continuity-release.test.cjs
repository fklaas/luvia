...
assert.match(version,/core:'4\.82\.100',build:'13\.82\.100'/);
...
])assert(index.includes(`${asset}?v=13.82.100`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.100'"));
...
console.log('App / Core / shell cache: 13.82.100 / 4.82.100 / luvia-shell-v13.82.100');
