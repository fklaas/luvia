...
assert.match(version,/core:'4\.82\.135',build:'13\.82\.135'/);
...
])assert(index.includes(`${asset}?v=13.82.135`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.135'"));
...
console.log('App / Core / shell cache: 13.82.135 / 4.82.135 / luvia-shell-v13.82.135');
