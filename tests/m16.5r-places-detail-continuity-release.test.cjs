...
assert.match(version,/core:'4\.82\.131',build:'13\.82\.131'/);
...
])assert(index.includes(`${asset}?v=13.82.131`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.131'"));
...
console.log('App / Core / shell cache: 13.82.131 / 4.82.131 / luvia-shell-v13.82.131');
