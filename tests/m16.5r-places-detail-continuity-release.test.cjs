...
assert.match(version,/core:'4\.82\.95',build:'13\.82\.95'/);
...
])assert(index.includes(`${asset}?v=13.82.95`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.95'"));
...
console.log('App / Core / shell cache: 13.82.95 / 4.82.95 / luvia-shell-v13.82.95');
