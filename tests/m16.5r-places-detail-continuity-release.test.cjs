...
assert.match(version,/core:'4\.82\.106',build:'13\.82\.106'/);
...
])assert(index.includes(`${asset}?v=13.82.106`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.106'"));
...
console.log('App / Core / shell cache: 13.82.106 / 4.82.106 / luvia-shell-v13.82.106');
