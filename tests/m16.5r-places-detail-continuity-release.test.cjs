...
assert.match(version,/core:'4\.82\.136',build:'13\.82\.136'/);
...
])assert(index.includes(`${asset}?v=13.82.136`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.136'"));
...
console.log('App / Core / shell cache: 13.82.136 / 4.82.136 / luvia-shell-v13.82.136');
