...
assert.match(version,/core:'4\.82\.65',build:'13\.82\.65'/);
...
])assert(index.includes(`${asset}?v=13.82.65`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.65'"));
...
console.log('App / Core / shell cache: 13.82.65 / 4.82.65 / luvia-shell-v13.82.65');
