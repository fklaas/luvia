...
assert.match(version,/core:'4\.82\.156',build:'13\.82\.156'/);
...
])assert(index.includes(`${asset}?v=13.82.156`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.156'"));
...
console.log('App / Core / shell cache: 13.82.156 / 4.82.156 / luvia-shell-v13.82.156');
