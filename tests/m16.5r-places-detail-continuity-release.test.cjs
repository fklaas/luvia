...
assert.match(version,/core:'4\.82\.146',build:'13\.82\.146'/);
...
])assert(index.includes(`${asset}?v=13.82.146`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.146'"));
...
console.log('App / Core / shell cache: 13.82.146 / 4.82.146 / luvia-shell-v13.82.146');
