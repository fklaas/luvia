...
assert.match(version,/core:'4\.82\.150',build:'13\.82\.150'/);
...
])assert(index.includes(`${asset}?v=13.82.150`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.150'"));
...
console.log('App / Core / shell cache: 13.82.150 / 4.82.150 / luvia-shell-v13.82.150');
