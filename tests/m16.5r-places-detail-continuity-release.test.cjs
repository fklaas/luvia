...
])assert(index.includes(`${asset}?v=13.82.93`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.93'"));
...
console.log('App / Core / shell cache: 13.82.93 / 4.82.93 / luvia-shell-v13.82.93');
