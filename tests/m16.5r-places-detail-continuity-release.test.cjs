...
assert.match(version,/core:'4\.82\.111',build:'13\.82\.111'/);
...
])assert(index.includes(`${asset}?v=13.82.111`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.111'"));
...
console.log('App / Core / shell cache: 13.82.111 / 4.82.111 / luvia-shell-v13.82.111');
