...
assert.match(version,/core:'4\.82\.127',build:'13\.82\.127'/);
...
])assert(index.includes(`${asset}?v=13.82.127`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.127'"));
...
console.log('App / Core / shell cache: 13.82.127 / 4.82.127 / luvia-shell-v13.82.127');
