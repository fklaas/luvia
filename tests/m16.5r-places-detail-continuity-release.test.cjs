...
assert.match(version,/core:'4\.82\.155',build:'13\.82\.155'/);
...
])assert(index.includes(`${asset}?v=13.82.155`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.155'"));
...
console.log('App / Core / shell cache: 13.82.155 / 4.82.155 / luvia-shell-v13.82.155');
