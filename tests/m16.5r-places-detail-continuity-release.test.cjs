...
assert.match(version,/core:'4\.82\.159',build:'13\.82\.159'/);
...
])assert(index.includes(`${asset}?v=13.82.159`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.159'"));
...
console.log('App / Core / shell cache: 13.82.159 / 4.82.159 / luvia-shell-v13.82.159');
