...
assert.match(version,/core:'4\.82\.96',build:'13\.82\.96'/);
...
])assert(index.includes(`${asset}?v=13.82.96`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.96'"));
...
console.log('App / Core / shell cache: 13.82.96 / 4.82.96 / luvia-shell-v13.82.96');
