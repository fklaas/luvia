...
assert.match(version,/core:'4\.82\.154',build:'13\.82\.154'/);
...
])assert(index.includes(`${asset}?v=13.82.154`),`active M16.5R cache key missing for ${asset}`);
assert(worker.includes("const CACHE='luvia-shell-v13.82.154'"));
...
console.log('App / Core / shell cache: 13.82.154 / 4.82.154 / luvia-shell-v13.82.154');
