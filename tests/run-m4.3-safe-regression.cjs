...
const SUITE = Object.freeze([
  ...['recovery-active-trip-reload','recovery-places-locality','recovery-places-viewport','recovery-runtime-build'].map(name=>({category:'Recovery behavioral gates',test:`tests/${name}.test.cjs`})),
  {
    category: 'Release',
