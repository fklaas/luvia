...
assert.match(todayExperience,/dashboard\.brief/,'Today must request the OpenAI-orchestrated brief after first paint');
assert.match(todayExperience,/KI entwirft · Owner-Cores belegen · ihr bestätigt/,'the visible Intelligence draft must state the confirmation boundary');
