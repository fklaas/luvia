...
const order=[
  'core/intelligence/intelligence-action-contract-core.js?v=13.82.157',
  'core/platform/booking-contract-adapter.js?v=13.82.157',
  'core/platform/journey-contract-adapter.js?v=13.82.157',
  'core/platform/trip-contract-adapter.js?v=13.82.157',
  'core/platform/places-contract-adapter.js?v=13.82.157',
  'core/ai/ai-action-runtime.js?v=13.82.157',
  'core/ai/ai-dashboard-service.js?v=13.82.157'
];
...
assert.ok(serviceWorker.includes("const CACHE='luvia-shell-v13.82.157'"));
