...
const order=[
  'core/intelligence/intelligence-action-contract-core.js?v=13.82.129',
  'core/platform/booking-contract-adapter.js?v=13.82.129',
  'core/platform/journey-contract-adapter.js?v=13.82.129',
  'core/platform/trip-contract-adapter.js?v=13.82.129',
  'core/platform/places-contract-adapter.js?v=13.82.129',
  'core/ai/ai-action-runtime.js?v=13.82.129',
  'core/ai/ai-dashboard-service.js?v=13.82.129'
];
...
assert.ok(serviceWorker.includes("const CACHE='luvia-shell-v13.82.129'"));
