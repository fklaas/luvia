...
const googleOffer={id:'google:strandkueche',providerPlaceId:'google:strandkueche',name:'Strandküche',types:['restaurant'],features:{servesVegetarianFood:true},coordinates:{latitude:54.024,longitude:10.754}};
