...
const counters={places:0,events:0,memory:0,identity:0,memoryWrites:0,identityWrites:0};
let uuidSequence=0;
...
assert.equal(core.policySnapshot().inputEnforcement.runtimeEnforced.length,21);
...
(async()=>{
  ...
  console.log('All registered runtime actions: 21/21 ENFORCED');
