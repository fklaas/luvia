...
assert.match(gateway,/version:'4\.38\.12-provider-media-cascade'/,'gateway health version must expose the automatic provider and exact-media cascade contract');
