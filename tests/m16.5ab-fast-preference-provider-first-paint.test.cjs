...
(async()=>{
  ...
  assert.match(indexSource,/vendor\/maplibre\/maplibre-gl-5\.12\.0\.js\?v=13\.82\.168\.100" defer/,'the same-origin map renderer must preserve execution order without blocking HTML parsing');
