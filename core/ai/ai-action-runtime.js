...
const VERSION='1.7.2-strict-restaurant-evidence';
...
async function dayResult(request){
  ...
  const days=(populatedDays.length?populatedDays:orderedDays.slice(0,1)).slice(0,3);
