...
const WATERFRONT_TERMS=/\b(?:strand[a-zäöüß]*|beach[a-z]*|seafront|waterfront|shore|coast(?:al)?|k[uü]ste|promenade|meer|sea|plage|littoral|playa|costa|praia|spiaggia|lungomare|kust|boulevard|marina|hafen|harbour|harbor|port)\b/i;
...
function accepts(place,categoryKey,goalText='',preferences={},options={}){
  ...
  if(intent.key==='vegetarian'){
    ...
    if(dietaryEvidence!=='confirmed')return false;
