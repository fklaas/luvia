...
function dataEntry(e){const metadata=e.fields?.metadata&&typeof e.fields.metadata==='object'?e.fields.metadata:{};return{id:e.id,rowId:null,sourceKey:e.id,tripId:e.tripId,placeId:e.placeId,tripPlaceId:e.tripPlaceId,providerPlaceId:e.record?.place?.provider_place_id||null,entityType:e.placeType,kind:e.kind,title:e.title,startAt:e.startAt,endAt:null,durationMinutes:null,automatic:false,source:'place-data',dataKey:e.dataKey,fields:e.fields||{},metadata:{placeName:e.record?.place?.name||'',...metadata},icon:typeIcon(e.placeType)}}
