...
const CAPABILITIES=Object.freeze([
  ...
  {id:'trip.compose',tier:'deep',mode:'READ',schema:'trip_itinerary',tools:['trip.current','preferences.current','travel.context'],timeoutMs:75000,cacheTtlMs:0,description:'Komponiert aus einem semantischen Reiseauftrag und bereits belegten Places einen vollständigen, bestätigungspflichtigen Tagesentwurf.'},
