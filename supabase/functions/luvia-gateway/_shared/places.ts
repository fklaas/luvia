...
const HEALTH_PROBES=Object.freeze({
  ...
  'spanish-scharbeutz':Object.freeze({query:'Spanisch Restaurant Scharbeutz',destination:Object.freeze({name:'Scharbeutz',countryCode:'DE',location:Object.freeze({latitude:54.0214,longitude:10.7536}),canonicalCity:Object.freeze({name:'Scharbeutz'}),searchRadiusMeters:5000}),options:Object.freeze({providers:Object.freeze(['auto']),category:'food',includedType:'spanish_restaurant',includedTypes:Object.freeze(['spanish_restaurant']),strictPlaceType:'spanish_restaurant',strictTypeFiltering:true,maxResultCount:50,maxDistanceMeters:5000,forceRefresh:true})}),
