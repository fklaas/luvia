...
const HEALTH_PROBES=Object.freeze({
  ...
  'chinese-scharbeutz':Object.freeze({query:'Chinesisch Restaurant',destination:Object.freeze({name:'Scharbeutz',countryCode:'DE',location:Object.freeze({latitude:54.0214,longitude:10.7536}),canonicalCity:Object.freeze({name:'Scharbeutz'}),searchRadiusMeters:15000}),options:Object.freeze({providers:Object.freeze(['auto']),category:'food',includedType:'chinese_restaurant',includedTypes:Object.freeze(['chinese_restaurant']),strictPlaceType:'chinese_restaurant',strictTypeFiltering:true})})
});
