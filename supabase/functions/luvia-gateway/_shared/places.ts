...
const CUISINE_HEALTH_PROBES=Object.fromEntries(CUISINE_HEALTH_TYPES.map(([slug,label,type])=>[
  `${slug}-scharbeutz`,
  Object.freeze({query:`${label} Restaurant Scharbeutz`,destination:SCHARBEUTZ_CUISINE_DESTINATION,options:Object.freeze({providers:Object.freeze(['auto']),category:'food',includedType:type,includedTypes:Object.freeze([type]),strictPlaceType:type,strictTypeFiltering:true,strictDestination:true,maxResultCount:50,maxDistanceMeters:5000})})
]));
