...
const LEISURE_TYPES:Record<string,string>=Object.freeze({park:'park',garden:'garden',nature_reserve:'natural_feature',playground:'playground',swimming_pool:'swimming_pool',water_park:'water_park',marina:'marina',fitness_centre:'fitness_center',sports_centre:'sports_activity_location',stadium:'stadium',pitch:'sports_activity_location',track:'sports_activity_location',golf_course:'golf_course',miniature_golf:'miniature_golf_course',horse_riding:'sports_activity_location',ice_rink:'skating_rink',spa:'spa',sauna:'spa'});
const SHOP_TYPES:Record<string,string>=Object.freeze({mall:'shopping_mall',department_store:'department_store',clothes:'clothing_store',fashion:'clothing_store',supermarket:'supermarket',convenience:'supermarket',bakery:'bakery',laundry:'laundry',sports:'sporting_goods_store',outdoor:'sporting_goods_store',surf:'sporting_goods_store',bicycle:'sporting_goods_store',toys:'toy_store'});
const TYPE_LABELS:Record<string,string>=Object.freeze({restaurant:'Restaurant',cafe:'Café',meal_takeaway:'Imbiss',food_court:'Food Court',bar:'Bar',pub:'Pub',biergarten:'Biergarten',night_club:'Club',casino:'Casino',live_music_venue:'Live-Musik',performing_arts_theater:'Theater',movie_theater:'Kino',art_gallery:'Galerie',concert_hall:'Konzertort',hotel:'Hotel',guest_house:'Gästehaus',apartment:'Apartment',hostel:'Hostel',motel:'Motel',campground:'Camping',vacation_rental:'Ferienhaus',museum:'Museum',tourist_attraction:'Sehenswürdigkeit',observation_deck:'Aussichtspunkt',amusement_park:'Freizeitpark',aquarium:'Aquarium',zoo:'Zoo',park:'Park',garden:'Garten',natural_feature:'Naturort',playground:'Spielplatz',swimming_pool:'Schwimmbad',water_park:'Wasserpark',marina:'Hafen',spa:'Wellness',golf_course:'Golfplatz',miniature_golf_course:'Minigolf',shopping_mall:'Einkaufszentrum',department_store:'Kaufhaus',clothing_store:'Modegeschäft',sporting_goods_store:'Sportgeschäft',toy_store:'Spielwarengeschäft',supermarket:'Supermarkt',store:'Geschäft',market:'Markt',pharmacy:'Apotheke',parking:'Parkplatz',electric_vehicle_charging_station:'Ladestation',atm:'Geldautomat',gas_station:'Tankstelle'});
...
function osmTypeProjection(tags:any={}){
  ...
  if(!type&&shop)type=SHOP_TYPES[shop]||'store';
