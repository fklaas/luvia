...
const typeRules:[string,RegExp][]=[
 ['restaurant',/\brestaurant|\bfood court|\bdining\b/],['cafe',/\bcafe\b|\bcoffee shop\b|\bcoffee tea\b/],['bakery',/\bbakery\b|\bbaker\b/],
 ['cocktail_bar',/\bcocktail bar\b|\bcocktail lounge\b/],['wine_bar',/\bwine bar\b/],['pub',/\bpub\b|\bpublic house\b/],['lounge_bar',/\bcocktail lounge\b|\bnightlife lounge\b|\bbeach club\b/],['bar',/\bbar\b|\bpub\b|\bpublic house\b/],
 ['jazz_club',/\bjazz club\b|\bjazz bar\b/],['comedy_club',/\bcomedy club\b|\bcomedy bar\b/],['karaoke_bar',/\bkaraoke\b/],['live_music_venue',/\blive entertainment music\b|\blive music\b|\bmusic venue\b/],['nightlife_spot',/\bnightlife entertainment\b|\bnightlife spot\b|^nightlife$/],['night_club',/\bnight club\b|\bnightclub\b|\bdisco/],['casino',/\bcasino\b|\bgaming parlour\b|\bgambling\b/],
 ['meal_takeaway',/\btake out\b|\btakeaway\b|\bfast food\b/],
...
export function normalizeAdditional(provider:string,row:any){
  ...
  const providerPrimaryFoodTypes=tt?[]:(row.foodTypes||[]).filter((foodType:any)=>foodType?.primary===true).map((foodType:any)=>String(foodType?.name||foodType?.id||'')).filter(Boolean);
