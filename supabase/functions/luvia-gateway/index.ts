  ...
  try{
    ...
    switch(action){
      ...
      case 'providers.status':
        ...
        break;
      case 'system.health':
        data={status:'ok',service:'luvia-gateway',version:'4.64.38',build:'13.82.168.174',core:'4.82.293',time:new Date().toISOString(),authenticated:Boolean(userId),places:placesDiagnostics(),restaurants:restaurantDiagnostics(),recommendations:recommendationDiagnostics()};
        break;
      default:
