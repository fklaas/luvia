  ...
  try{
    ...
    switch(action){
      ...
      case 'providers.status':
        ...
        break;
      case 'system.health':
        data={status:'ok',service:'luvia-gateway',version:'4.64.40',build:'13.82.168.204',core:'4.82.323',time:new Date().toISOString(),authenticated:Boolean(userId),places:placesDiagnostics(),restaurants:restaurantDiagnostics(),recommendations:recommendationDiagnostics()};
        break;
      default:
