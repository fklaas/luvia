...
Deno.serve(async(req)=>{
 ...
 try{
  ...
  return json({ok:true,version:'2.0.1',build:'13.68.1',core:'4.68.1',provider:'resend',providerReference:resendPayload.id,requestId:requestRow.id,threadId:thread.id,channel:'email',status:finalStatus,mode,intendedRecipient,actualRecipient,replyTo:replyAlias,message:storedMessage});
